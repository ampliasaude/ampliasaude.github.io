"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[38],{8659:function(e,t,i){e.exports=i.p+"static/media/186949b230e46bbd80611c8b1224e2003c90fd71528ff034cabe25dc74445f782670632623e35cfdc778c27fcc6fce67fe7fc4e12ef7168cbf594a25934412d3.fe6d926d.csv"},4084:function(e,t,i){e.exports=i.p+"static/media/f2201770123f4b364781aee7ac3512db444637a3ad42ef096c62d05e6637e8d48b4875ec59b514f9f028ae6c85b557a5d74de4b1e2d1c18d62c5114c6c9c27fa.213d22d6.csv"},3038:function(e,t,i){function a(e){return e`# Amplia Saude - Fonte de Dados e Menu - AGO2022`}function n(e){return e`## Menu Amplia`}function o(e){return function(t,i){let a=`<svg width="19" height="10" viewBox="0 0 19 10" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</div>`}}function el(e,t,i,a,n,o,r,l,s,d,c,u,p,m,f,v,h,x,b,g,y,A,E,w,C,O,_,I,T){return M=>{if(!e.map(e=>e.nome).every(e=>t.filter(e=>e.idx==M).map(e=>e.municipio).includes(e))||a.find(e=>e.i==M).filtros.value.expression&&a.find(e=>e.i==M).show_filtros&&t.filter(e=>e.idx==M).every(e=>void 0===e.filtrado)||n.value.expression&&t.filter(e=>e.idx==M).every(e=>void 0!==e.filtrado))return i();let S=a.find(e=>e.i==M).escala,P=a.find(e=>e.i==M).tamanho,D=o.plot({marginTop:5,marginRight:0,width:r-65,height:l,x:{grid:!0,label:null,domain:a.find(e=>e.i==M).alterar_tempo?a.find(e=>e.i==M).alterar_tempo.map(e=>s[e].inicio):d.map(e=>s[e].inicio)},y:{grid:!0,label:null},marks:[a.find(e=>e.i==M).mostra_media_movel?t.filter(e=>e.idx==M).map((t,i)=>o.line(t.dados.filter(e=>c(e,M)),o.windowY({strict:!0,k:u,anchor:"middle",x:"x",y:e=>e[S][P],strokeWidth:t.filtrado?p:m,stroke:e.find(e=>e.nome==t.municipio).cor,strokeDasharray:t.filtrado?"3":"1"}))):t.filter(e=>e.idx==M).map((t,i)=>o.line(t.dados.filter(e=>c(e,M)),{sort:"x",x:"x",y:e=>e[S][P],curve:"monotone-x",strokeWidth:t.filtrado?p:m,stroke:e.find(e=>e.nome==t.municipio).cor,strokeDasharray:t.filtrado?"3":"1"})),o.ruleX([t.filter(e=>e.idx==M)[0].dados[f.center(t.filter(e=>e.idx==M)[0].dados,v)]],{x:"x",strokeDasharray:"5"}),a.find(e=>e.i==M).mostra_media_movel?null:t.filter(e=>e.idx==M).map((t,i)=>o.dot([t.dados[f.center(t.dados,v)]],{x:"x",y:e=>e[S][P],fill:e.find(e=>e.nome==t.municipio).cor}))]});h(D,"PIG",M,S,P),x(D);let N;return b`
...
<div class="trilha" i=${M}>
  <div class="cabecalho-trilha">
    ...
    ${(N=y.create("select").attr("class","menuIG")).style("font-family","Roboto Condensed"),N.append("option").attr("name","PEQUENO").text("PEQUENO").property("selected","PEQUENO"==a.find(e=>e.i==M).tamanho),N.append("option").attr("name","ADEQUADO").text("ADEQUADO").property("selected","ADEQUADO"==a.find(e=>e.i==M).tamanho),N.append("option").attr("name","GRANDE").text("GRANDE").property("selected","GRANDE"==a.find(e=>e.i==M).tamanho),N.on("change",w),N.node()}
...
</svg>`;return o.onclick=()=>{n(`${t}?conf=${i(a())}`)},o}}function tn(e){return e`## Poluentes`}function to(){return{pm25_ugm3:120,so2_ugm3:90,no2_ppb:286,o3_ppb:154,co_ppb:9.9}}function tr(){return e=>.08206*(e+293.15)}function tl(){return{no2_ppb:46.0055,o3_ppb:48,co_ppb:28.01}}function ts(){return{pm25_ugm3:[25,37,50,60],so2_ugm3:[20,30,40,60],no2_ppb:[200,220,240,260],o3_ppb:[100,120,130,140],co_ppb:[9,9,9,9]}}function td(e,t){return(i,a="TRUE")=>t(i,`
      select 
        ano,
        mes,
        dia,
...
`}function tO(e){return e("https://bundle.run/lz-string@1.4.4")}function t_(e){return e`<style>
  @import url(https://fonts.googleapis.com/css2?family=Roboto+Condensed:wght@300;400;700&display=swap);
  @import url(https://fonts.googleapis.com/icon?family=Material+Icons);    
</style>
