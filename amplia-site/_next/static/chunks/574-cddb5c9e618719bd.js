...
</svg>`}async function af(e){return await e("da.png").url()}function ap(e){return new URL(e)}function am(e,t){return t.html`<div style="background:url(${e}) right; background-size:10px; background-repeat:no-repeat;">XXX  `}function av(e,t){let n=e.module(),a=new Map([["da.png",{url:new i.U(i(9555)),mimeType:"image/png",toString:function(){return this.url}}]]);return n.builtin("FileAttachment",e.fileAttachments(e=>a.get(e))),n.variable(t()).define(["md"],aa),n.variable(t()).define(["aSelect"],ar),n.variable(t("viewof term")).define("viewof term",["aText"],ao),n.variable(t("term")).define("term",["Generators","viewof term"],(e,t)=>e.input(t)),n.variable(t()).define(["term"],al),n.variable(t("aText")).define("aText",["htl"],as),n.variable(t("aSelect")).define("aSelect",["htl"],au),n.variable(t("aSelectStyles")).define("aSelectStyles",["daPath","htl"],ad),n.variable(t("downArrow")).define("downArrow",["htl"],ac),n.variable(t("daPath")).define("daPath",["FileAttachment"],af),n.variable(t("daUrl")).define("daUrl",["daPath"],ap),n.variable(t()).define(["daPath","htl"],am),n}function ab(e){return e`# Amplia Saúde - Mapa (cópia 8 outubro)
