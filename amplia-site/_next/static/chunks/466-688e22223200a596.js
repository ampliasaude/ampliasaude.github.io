...
~~~`}function eB(e){return e([-122.27,37.87])}function eG(e){return e}function eU(e){return e({title:"A Mini Map",description:"Defaults to New York City",width:200,value:[-74,40.71]})}function ez(e){return e}function eV(e,t,i,n,a,r){return function(o={}){let{value:l=[],title:s,description:u,width:d=400}=Array.isArray(o)?{value:o}:o,c=d/960,f=600*c,[p,m]=l;p=null!=p?p:null,m=null!=m?m:null;let v=e`<form style="width: ${d}px;"></form>`,b=t.context2d(d,f),h=b.canvas;h.style.margin="5px 0 20px";let g=i.geoAlbersUsa().scale(1280).translate([480,300]),w=i.geoPath().context(b).pointRadius(2.5/c);function y(){if(b.clearRect(0,0,d,f),b.save(),b.scale(c,c),b.lineWidth=.35/c,b.beginPath(),w(n),b.fillStyle="#f4f4f4",b.fill(),b.beginPath(),w(a),b.strokeStyle="#aaa",b.stroke(),null!=p&&null!=m){let e={type:"MultiPoint",coordinates:[g([p,m])]};b.beginPath(),w(e),b.fillStyle="#f00",b.fill()}b.restore()}v.append(h),h.onclick=function(e){let{offsetX:t,offsetY:i}=e;var n=g.invert([t/c,i/c]);p=+n[0].toFixed(2),m=+n[1].toFixed(2),y(),h.dispatchEvent(new CustomEvent("input",{bubbles:!0}))},y();let x=r({type:"worldMapCoordinates",title:s,description:u,display:t=>e`<div style="position: absolute; width: ${d}px; white-space: nowrap; color: #444; text-align: center; font: 13px sans-serif; margin-top: -18px;">
          ...
          </div>`,getValue:()=>[null!=p?p:null,null!=m?m:null],form:v});return x}}function e_(e){return e` ---
## Dates
...
~~~`}function eq(e){return e()}function eH(e){return e({title:"2017",min:"2017-01-01",max:"2017-12-31",value:"2017-01-01",description:"Only dates within the 2017 calendar year are allowed"})}function eW(e){return function(t={}){let{min:i,max:n,value:a,title:r,description:o,disabled:l,display:s}="string"==typeof t?{value:t}:t;return e({type:"date",title:r,description:o,display:s,attributes:{min:i,max:n,disabled:l,value:a}})}}function eZ(e){return e` ---
## Times
...
It worked!`}function t8(e){return e`### This is a sub-section`}function t9(e){return e`A little text`}function ie(e){return e`#### A sub-sub-section?`}function it(e){return e`##### A sub-sub-sub-section?`}function ii(e){return e`###### A sub-sub-sub-sub-section! (h6!)`}function ia(e){return e`### Another sub-section`}function ir(e,t){let i=e.module();return i.variable(t()).define(["md"],t2),i.variable(t()).define(["toc"],t4),i.variable(t()).define(["md"],t3),i.variable(t("toc")).define("toc",["Generators","html","DOM","MutationObserver"],t6),i.variable(t()).define(["md"],t7),i.variable(t()).define(["md"],t8),i.variable(t()).define(["md"],t9),i.variable(t()).define(["md"],ie),i.variable(t()).define(["md"],it),i.variable(t()).define(["md"],ii),i.variable(t()).define(["md"],ia),i}function io(e){return e`# Keys
...
</style>`}function n2(e,t){let i=e.module();return i.variable(t()).define(["md"],nK),i.variable(t("viewof testSingle")).define("viewof testSingle",["aSlider","d3"],nQ),i.variable(t("testSingle")).define("testSingle",["Generators","viewof testSingle"],(e,t)=>e.input(t)),i.variable(t("viewof testInterval")).define("viewof testInterval",["aSlider","d3"],n1),i.variable(t("testInterval")).define("testInterval",["Generators","viewof testInterval"],(e,t)=>e.input(t)),i.variable(t("aSlider")).define("aSlider",["htl","d3"],n0),i.variable(t("aSliderStyles")).define("aSliderStyles",["htl"],n5),i}function n4(e){return e`# ADrawer`}function n3(e,t){return e(t,{shown:!0,title:"Nascimentos",subtitle:"Exibir somente munic\xedpios com total de nascimentos entre:"})}function n6(e){return e({values:[0,10,100,1e3,1e5,1e6],value:[0,1e6],width:300,rulerThickness:16,thumbHeight:20,height:50,margin:20})}function n7(e){return e}function n8(e){return()=>e.html`<svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
