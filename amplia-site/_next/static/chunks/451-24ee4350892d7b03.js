"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[451],{474:function(e,t,i){e.exports=i.p+"static/media/186949b230e46bbd80611c8b1224e2003c90fd71528ff034cabe25dc74445f782670632623e35cfdc778c27fcc6fce67fe7fc4e12ef7168cbf594a25934412d3.fe6d926d.csv"},3656:function(e,t,i){e.exports=i.p+"static/media/f2201770123f4b364781aee7ac3512db444637a3ad42ef096c62d05e6637e8d48b4875ec59b514f9f028ae6c85b557a5d74de4b1e2d1c18d62c5114c6c9c27fa.213d22d6.csv"},5451:function(e,t,i){function a(e){return e`# Amplia Saude - Fonte de Dados e Menu - AGO2022`}function n(e){return e`## Menu Amplia`}function o(e){return function(t,i){let a=`<svg width="19" height="10" viewBox="0 0 19 10" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`).on("change",e=>{if(!a.map(e=>e.municipio).includes(document.getElementById("menu-municipios").value)&&!i.includes(document.getElementById("menu-municipios").value))return;let t=e.target.value;if(!(n.length==o||n.map(e=>e.nome).includes(t))){for(let f of(r.value=r.value.concat([{nome:t,cor:l.find(e=>!n.map(e=>e.cor).includes(e))}]),s))"PM25"==f.variavel&&i.includes(t)||Promise.all([d[f.variavel](t,"PM25"!=f.variavel?c.value.expression:null)]).then(e=>{u.value=u.value.concat({idx:f.i,municipio:t,variavel:f.variavel,dados:p[f.variavel](e[0])})});for(let v of[...new Set(m.filter(e=>e.filtrado).map(e=>e.idx))])Promise.all([d[s.find(e=>e.i==v).variavel](t,s.find(e=>e.i==v).filtros.value.expression)]).then(e=>{u.value=u.value.concat({idx:v,municipio:t,variavel:m.find(e=>e.idx==v).variavel,filtrado:!0,dados:p[m.find(e=>e.idx==v).variavel](e[0])})})}}).node()}function H(e,t,i,a,n,o,r){return(l,s)=>{let d=e.create("button").attr("class","btn-municipio").style("background-color",l.cor).style("display","inline-flex").style("align-items","flex-center").on("click",e=>{t.length>1&&(i.value=t.filter(e=>e!=l),a.value=n.filter(e=>e.municipio!=l.nome))});return o.includes(l.nome)?d.append("span").text(l.nome):d.append("span").text(l.nome+(l.nome.includes("(")?"":" ("+r.find(e=>e.municipio==l.nome).sigla+")")),d.append("span").attr("class","material-icons-outlined").style("font-size","16px").style("margin-left","5px").style("display",1==t.length?"none":"inline").text("remove_circle_outline"),d.node()}}function V(e,t){return()=>e.create("button").attr("class","btn-remove").text("–").on("click",t).attr("title","Eliminar trilha").node()}function j(e,t){return()=>{let i=e.create("button").attr("class","btn-remove").on("click",t);return i.append("span").attr("class","material-icons-outlined").style("font-size","10px").text("content_copy"),i.attr("title","Duplicar trilha"),i.node()}}function z(e,t,i,a){return{PM25:e,PESO:t,ROBSON:i,TOTAL:a}}function Z(e,t,i,a){return{PM25:e,PESO:t,ROBSON:i,TOTAL:a}}function J(e,t,i,a){return{PM25:e,PESO:t,ROBSON:i,TOTAL:a}}function q(e){return e`
...
</div>`}}function ed(e,t,i,a,n,o,r,l,s,d,c,u,p){return function(m,f="valor",v=null){let h=e.find(e=>e.i==m).variavel;return t.filter(e=>e.idx==m).map(e=>e.filtrado).some(e=>e)?i`<div class="lista-valores interior-trilha" style="display:flex;flex-direction:column;justify-content:space-between;">
...
</div>`}}function ec(e,t,i,a,n,o){return r=>{let l;return e`
...
`}function tE(e){return e("https://bundle.run/lz-string@1.4.4")}function tO(e){return e`<style>
  @import url(https://fonts.googleapis.com/css2?family=Roboto+Condensed:wght@300;400;700&display=swap);
  @import url(https://fonts.googleapis.com/icon?family=Material+Icons);    
</style>
