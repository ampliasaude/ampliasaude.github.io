(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[481],{1163:function(e,t,a){e.exports=a(387)},582:function(e,t,a){"use strict";e.exports=a.p+"static/media/186949b230e46bbd80611c8b1224e2003c90fd71528ff034cabe25dc74445f782670632623e35cfdc778c27fcc6fce67fe7fc4e12ef7168cbf594a25934412d3.fe6d926d.csv"},2221:function(e,t,a){"use strict";e.exports=a.p+"static/media/f2201770123f4b364781aee7ac3512db444637a3ad42ef096c62d05e6637e8d48b4875ec59b514f9f028ae6c85b557a5d74de4b1e2d1c18d62c5114c6c9c27fa.213d22d6.csv"},3612:function(e,t,a){"use strict";function i(e){return e`# Amplia Saude - Fonte de Dados e Menu - AGO2022`}function n(e){return e`## Menu Amplia`}function l(e){return function(t,a){let i=`<svg width="19" height="10" viewBox="0 0 19 10" fill="none" xmlns="http://www.w3.org/2000/svg">
...
${t.map((e,t)=>a(e,t))}${t.length<i?n:""}`}function U(e,t,a,i,n,l,o,r,s,d,c,u,p,m){return e.select(t`
...
`).on("change",e=>{if(!i.map(e=>e.municipio).includes(document.getElementById("menu-municipios").value)&&!a.includes(document.getElementById("menu-municipios").value))return;let t=e.target.value;if(!(n.length==l||n.map(e=>e.nome).includes(t))){for(let f of(o.value=o.value.concat([{nome:t,cor:r.find(e=>!n.map(e=>e.cor).includes(e))}]),s))"PM25"==f.variavel&&a.includes(t)||Promise.all([d[f.variavel](t,"PM25"!=f.variavel?c.value.expression:null)]).then(e=>{u.value=u.value.concat({idx:f.i,municipio:t,variavel:f.variavel,dados:p[f.variavel](e[0])})});for(let v of[...new Set(m.filter(e=>e.filtrado).map(e=>e.idx))])Promise.all([d[s.find(e=>e.i==v).variavel](t,s.find(e=>e.i==v).filtros.value.expression)]).then(e=>{u.value=u.value.concat({idx:v,municipio:t,variavel:m.find(e=>e.idx==v).variavel,filtrado:!0,dados:p[m.find(e=>e.idx==v).variavel](e[0])})})}}).node()}function B(e,t,a,i,n){return l=>{e.value.filter(e=>"PM25"!=e.variavel).forEach(e=>{t.value=t.value.filter(t=>t.idx!=e.i||t.filtrado),a.value.forEach(a=>{Promise.all([i[e.variavel](a.nome,l.target.value.expression)]).then(i=>{t.value=t.value.filter(t=>t.idx!=e.i||t.filtrado||t.municipio!=a.nome),t.value=t.value.concat({idx:e.i,municipio:a.nome,variavel:e.variavel,dados:n[e.variavel](i[0])})})})})}}function H(e,t,a,i,n,l,o){return(r,s)=>{let d=e.create("button").attr("class","btn-municipio").style("background-color",r.cor).style("display","inline-flex").style("align-items","flex-center").on("click",e=>{t.length>1&&(a.value=t.filter(e=>e!=r),i.value=n.filter(e=>e.municipio!=r.nome))});return l.includes(r.nome)?d.append("span").text(r.nome):d.append("span").text(r.nome+(r.nome.includes("(")?"":" ("+o.find(e=>e.municipio==r.nome).sigla+")")),d.append("span").attr("class","material-icons-outlined").style("font-size","16px").style("margin-left","5px").style("display",1==t.length?"none":"inline").text("remove_circle_outline"),d.node()}}function V(e,t){return()=>e.create("button").attr("class","btn-remove").text("–").on("click",t).attr("title","Eliminar trilha").node()}function G(e,t){return()=>{let a=e.create("button").attr("class","btn-remove").on("click",t);return a.append("span").attr("class","material-icons-outlined").style("font-size","10px").text("content_copy"),a.attr("title","Duplicar trilha"),a.node()}}function j(e,t,a,i,n){return{PM25:e,NEONATAL:t,RELPARTO:a,FETAL:i,TOTAL:n}}function z(e,t,a,i,n){return{PM25:e,NEONATAL:t,TOTAL:a,FETAL:i,RELPARTO:n}}function Z(e,t,a,i,n){return{PM25:e,NEONATAL:t,TOTAL:a,FETAL:i,RELPARTO:n}}function J(){return{PM25:"#F4947C",FETAL:"#DDD9FC",NEONATAL:"#FFD8FD",RELPARTO:"#FCEBD4",TOTAL:"#D9E7FC"}}function q(){return{PM25:"#FDEEEA",FETAL:"#EEECFD",NEONATAL:"#FFEAFE",RELPARTO:"#FFF7ED",TOTAL:"#ECF4FF"}}function W(e){return e`
