(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[737],{1163:function(e,t,a){e.exports=a(387)},582:function(e,t,a){"use strict";e.exports=a.p+"static/media/186949b230e46bbd80611c8b1224e2003c90fd71528ff034cabe25dc74445f782670632623e35cfdc778c27fcc6fce67fe7fc4e12ef7168cbf594a25934412d3.fe6d926d.csv"},8586:function(e,t,a){"use strict";e.exports=a.p+"static/media/f2201770123f4b364781aee7ac3512db444637a3ad42ef096c62d05e6637e8d48b4875ec59b514f9f028ae6c85b557a5d74de4b1e2d1c18d62c5114c6c9c27fa.213d22d6.csv"},7824:function(e,t,a){"use strict";function i(e){return e`# Amplia Saude - Fonte de Dados e Menu - AGO2022`}function n(e){return e`## Menu Amplia`}function l(e){return function(t,a){let i=`<svg width="19" height="10" viewBox="0 0 19 10" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="trilha" i=${M}>
  <div class="cabecalho-trilha">
    ...
    <div class="opcao-trilha">
      <label class="label-cabecalho-trilha">MÉDIA MÓVEL</label>       ${T.create("input").attr("type","checkbox").property("checked",n.find(e=>e.i==M).mostra_media_movel).on("change",e=>_(e,M)).node()}
    </div>
    <div class="opcao-trilha">
    <label class="label-cabecalho-trilha">MODIFICAR PERÍODO</label> ${T.create("input").attr("type","checkbox").property("checked",n.find(e=>e.i==M).alterar_tempo).on("change",e=>O(e,M)).node()}
  </div>
...
</div>`}}function et(e,t,a,i,n,l,o,r,s,d,c,u,p,m,f,v,h,x,b,g,y,A,E,T,w,C,_,O){return I=>{if(!e.map(e=>e.nome).every(e=>t.filter(e=>e.idx==I).map(e=>e.municipio).includes(e))||i.find(e=>e.i==I).filtros.value.expression&&i.find(e=>e.i==I).show_filtros&&t.filter(e=>e.idx==I).every(e=>void 0===e.filtrado)||n.value.expression&&t.filter(e=>e.idx==I).every(e=>void 0!==e.filtrado))return a();let M=i.find(e=>e.i==I).escala,L=l.plot({marginTop:5,marginRight:0,width:o-65,height:r,x:{grid:!0,label:null,domain:i.find(e=>e.i==I).alterar_tempo?i.find(e=>e.i==I).alterar_tempo.map(e=>s[e].inicio):d.map(e=>s[e].inicio)},y:{grid:!0,label:null},marks:[i.find(e=>e.i==I).mostra_media_movel?t.filter(e=>e.idx==I).map((t,a)=>l.line(t.dados.filter(e=>c(e,I)),l.windowY({strict:!0,k:u,anchor:"middle",x:"x",y:e=>e[M],strokeWidth:t.filtrado?p:m,stroke:e.find(e=>e.nome==t.municipio).cor,strokeDasharray:t.filtrado?"3":"1"}))):t.filter(e=>e.idx==I).map((t,a)=>l.line(t.dados.filter(e=>c(e,I)),{sort:"x",x:"x",y:e=>e[M],curve:"monotone-x",strokeWidth:t.filtrado?p:m,stroke:e.find(e=>e.nome==t.municipio).cor,strokeDasharray:t.filtrado?"3":"1"})),l.ruleX([t.filter(e=>e.idx==I)[0].dados[f.center(t.filter(e=>e.idx==I)[0].dados,v)]],{x:"x",strokeDasharray:"5"}),i.find(e=>e.i==I).mostra_media_movel?null:t.filter(e=>e.idx==I).map((t,a)=>l.dot([t.dados[f.center(t.dados,v)]],{x:"x",y:e=>e[M],fill:e.find(e=>e.nome==t.municipio).cor}))]});return h(L,"FETAL",I,M),x(I,L),b`
...
</div>`}}function ea(e,t,a,i,n,l,o,r,s,d,c,u,p,m,f,v,h,x,b,g,y,A,E,T,w,C,_,O,I){return M=>{if(!e.map(e=>e.nome).every(e=>t.filter(e=>e.idx==M).map(e=>e.municipio).includes(e))||i.find(e=>e.i==M).filtros.value.expression&&i.find(e=>e.i==M).show_filtros&&t.filter(e=>e.idx==M).every(e=>void 0===e.filtrado)||n.value.expression&&t.filter(e=>e.idx==M).every(e=>void 0!==e.filtrado))return a();let L=i.find(e=>e.i==M).escala,N=i.find(e=>e.i==M).neonatal,k=l.plot({marginTop:5,marginRight:0,width:o-65,height:r,x:{grid:!0,label:null,domain:i.find(e=>e.i==M).alterar_tempo?i.find(e=>e.i==M).alterar_tempo.map(e=>s[e].inicio):d.map(e=>s[e].inicio)},y:{grid:!0,label:null},marks:[i.find(e=>e.i==M).mostra_media_movel?t.filter(e=>e.idx==M).map((t,a)=>l.line(t.dados.filter(e=>c(e,M)),l.windowY({strict:!0,k:u,anchor:"middle",x:"x",y:e=>e[L][N],strokeWidth:t.filtrado?p:m,stroke:e.find(e=>e.nome==t.municipio).cor,strokeDasharray:t.filtrado?"3":"1"}))):t.filter(e=>e.idx==M).map((t,a)=>l.line(t.dados.filter(e=>c(e,M)),{sort:"x",x:"x",y:e=>e[L][N],curve:"monotone-x",strokeWidth:t.filtrado?p:m,stroke:e.find(e=>e.nome==t.municipio).cor,strokeDasharray:t.filtrado?"3":"1"})),l.ruleX([t.filter(e=>e.idx==M)[0].dados[f.center(t.filter(e=>e.idx==M)[0].dados,v)]],{x:"x",strokeDasharray:"5"}),i.find(e=>e.i==M).mostra_media_movel?null:t.filter(e=>e.idx==M).map((t,a)=>l.dot([t.dados[f.center(t.dados,v)]],{x:"x",y:e=>e[L][N],fill:e.find(e=>e.nome==t.municipio).cor}))]});h(k,"NEONATAL",M,L,N),x(M,k);let S;return b`
...
<div class="sombra">
<div class="drag-container">
<span class="material-icons-outlined ${i[0].i==M?"icon-gray":"icon-blue"}">
expand_less
</span>
<div class="drag">
  <span class="material-icons-outlined icon-blue">
...
<span class="material-icons-outlined ${i[i.length-1].i==M?"icon-gray":"icon-blue"}">
expand_more
</span>
</div>
<div class="trilha" i=${M}>
  <div class="cabecalho-trilha">
    ...
    ${(S=y.create("select").attr("class","menuIG")).style("font-family","Roboto Condensed"),S.append("option").attr("name","PRECOCE").text("PRECOCE").property("selected","PRECOCE"==i.find(e=>e.i==M).neonatal),S.append("option").attr("name","TARDIO").text("TARDIO").property("selected","TARDIO"==i.find(e=>e.i==M).neonatal),S.append("option").attr("name","NEOTOTAL").attr("value","NEOTOTAL").text("PRECOCE+TARDIO").property("selected","NEOTOTAL"==i.find(e=>e.i==M).neonatal),S.append("option").attr("name","POS").text("POS").property("selected","POS"==i.find(e=>e.i==M).neonatal),S.on("change",e=>T(e,M)),S.node()}

    <div class="opcao-trilha">
    <label class="label-cabecalho-trilha">MÉDIA MÓVEL</label> ${y.create("input").attr("type","checkbox").property("checked",i.find(e=>e.i==M).mostra_media_movel).on("change",e=>w(e,M)).node()}
    </div>
    <div class="opcao-trilha">
    <label class="label-cabecalho-trilha">MODIFICAR PERÍODO</label> ${y.create("input").attr("type","checkbox").property("checked",i.find(e=>e.i==M).alterar_tempo).on("change",e=>C(e,M)).node()}
    </div>
    <div class="opcao-trilha">
    
    <label class="label-cabecalho-trilha">ESCALA ABSOLUTO</label>
    ${y.create("input").attr("type","radio").attr("name","escala_"+M).property("checked","absoluto"==i.find(e=>e.i==M).escala).attr("value","absoluto").on("change",e=>_(e,M)).node()}
    </div>
    <div class="opcao-trilha">
    <label class="label-cabecalho-trilha"> PERCENTUAL</label>
    ${y.create("input").attr("type","radio").attr("name","escala_"+M).property("checked","percentual"==i.find(e=>e.i==M).escala).attr("value","percentual").on("change",e=>_(e,M)).node()}
    </div>
    <div class="opcao-trilha">
    <label class="label-cabecalho-trilha"> TAXA POR 1000</label>
    ${y.create("input").attr("type","radio").attr("name","escala_"+M).property("checked","taxa"==i.find(e=>e.i==M).escala).attr("value","taxa").on("change",e=>_(e,M)).node()}
    </div>
    <span class="fonte">Fonte: SIM</span>
  </div>
...
<div class="rodape-trilha">
<div class="botao-comparacao">
${y.create("input").attr("type","checkbox").property("checked",i.find(e=>e.i==M).show_filtros).on("change",e=>I(e,M)).node()}
<label>COMPARAÇÃO</label>
</div>
<div class="menu-local">${i.find(e=>e.i==M).show_filtros?i.find(e=>e.i==M).filtros:""}</div>
</div>
</div>
</div>
</div>`}}function ei(e,t,a,i,n,l,o,r,s,d,c,u,p,m,f,v,h,x,b,g,y,A,E,T,w,C,_,O,I){return M=>{if(!e.map(e=>e.nome).every(e=>t.filter(e=>e.idx==M).map(e=>e.municipio).includes(e))||i.find(e=>e.i==M).filtros.value.expression&&i.find(e=>e.i==M).show_filtros&&t.filter(e=>e.idx==M).every(e=>void 0===e.filtrado)||n.value.expression&&t.filter(e=>e.idx==M).every(e=>void 0!==e.filtrado))return a();let L=i.find(e=>e.i==M).escala,N=i.find(e=>e.i==M).relparto,k=l.plot({marginTop:5,marginRight:0,width:o-65,height:r,x:{grid:!0,label:null,domain:i.find(e=>e.i==M).alterar_tempo?i.find(e=>e.i==M).alterar_tempo.map(e=>s[e].inicio):d.map(e=>s[e].inicio)},y:{grid:!0,label:null},marks:[i.find(e=>e.i==M).mostra_media_movel?t.filter(e=>e.idx==M).map((t,a)=>l.line(t.dados.filter(e=>c(e,M)),l.windowY({strict:!0,k:u,anchor:"middle",x:"x",y:e=>e[L][N],strokeWidth:t.filtrado?p:m,stroke:e.find(e=>e.nome==t.municipio).cor,strokeDasharray:t.filtrado?"3":"1"}))):t.filter(e=>e.idx==M).map((t,a)=>l.line(t.dados.filter(e=>c(e,M)),{sort:"x",x:"x",y:e=>e[L][N],curve:"monotone-x",strokeWidth:t.filtrado?p:m,stroke:e.find(e=>e.nome==t.municipio).cor,strokeDasharray:t.filtrado?"3":"1"})),l.ruleX([t.filter(e=>e.idx==M)[0].dados[f.center(t.filter(e=>e.idx==M)[0].dados,v)]],{x:"x",strokeDasharray:"5"}),i.find(e=>e.i==M).mostra_media_movel?null:t.filter(e=>e.idx==M).map((t,a)=>l.dot([t.dados[f.center(t.dados,v)]],{x:"x",y:e=>e[L][N],fill:e.find(e=>e.nome==t.municipio).cor}))]});h(k,"RELPARTO",M,L,N),x(M,k);let S;return b`
...
<div class="trilha" i=${M}>
  <div class="cabecalho-trilha">
    ...
    ${(S=y.create("select").attr("class","menuIG")).style("font-family","Roboto Condensed"),S.append("option").attr("name","ANTES").text("ANTES").property("selected","ANTES"==i.find(e=>e.i==M).relparto),S.append("option").attr("name","DURANTE").text("DURANTE").property("selected","DURANTE"==i.find(e=>e.i==M).relparto),S.append("option").attr("name","DEPOIS").text("DEPOIS").property("selected","DEPOIS"==i.find(e=>e.i==M).relparto),S.on("change",e=>T(e,M)),S.node()}
...
</div>`}}function en(e,t,a,i,n,l,o,r,s,d,c,u,p,m,f,v,h,x,b,g,y,A,E,T,w,C,_,O){return I=>{if(!e.map(e=>e.nome).every(e=>t.filter(e=>e.idx==I).map(e=>e.municipio).includes(e))||i.find(e=>e.i==I).filtros.value.expression&&i.find(e=>e.i==I).show_filtros&&t.filter(e=>e.idx==I).every(e=>void 0===e.filtrado)||n.value.expression&&t.filter(e=>e.idx==I).every(e=>void 0!==e.filtrado))return a();let M=i.find(e=>e.i==I).escala,L=l.plot({marginTop:5,marginRight:0,width:o-65,height:r,x:{grid:!0,label:null,domain:i.find(e=>e.i==I).alterar_tempo?i.find(e=>e.i==I).alterar_tempo.map(e=>s[e].inicio):d.map(e=>s[e].inicio)},y:{grid:!0,label:null},marks:[i.find(e=>e.i==I).mostra_media_movel?t.filter(e=>e.idx==I).map((t,a)=>l.line(t.dados.filter(e=>c(e,I)),l.windowY({strict:!0,k:u,anchor:"middle",x:"x",y:e=>e[M],strokeWidth:t.filtrado?p:m,stroke:e.find(e=>e.nome==t.municipio).cor,strokeDasharray:t.filtrado?"3":"1"}))):t.filter(e=>e.idx==I).map((t,a)=>l.line(t.dados.filter(e=>c(e,I)),{sort:"x",x:"x",y:e=>e[M],curve:"monotone-x",strokeWidth:t.filtrado?p:m,stroke:e.find(e=>e.nome==t.municipio).cor,strokeDasharray:t.filtrado?"3":"1"})),l.ruleX([t.filter(e=>e.idx==I)[0].dados[f.center(t.filter(e=>e.idx==I)[0].dados,v)]],{x:"x",strokeDasharray:"5"}),i.find(e=>e.i==I).mostra_media_movel?null:t.filter(e=>e.idx==I).map((t,a)=>l.dot([t.dados[f.center(t.dados,v)]],{x:"x",y:e=>e[M],fill:e.find(e=>e.nome==t.municipio).cor}))]});return h(L,"TOTAL",I,M),x(I,L),b`
