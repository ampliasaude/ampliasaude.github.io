...
</svg>`,o=0,r=Symbol(),l=Symbol(),s=Symbol();function d(a,n,d,u){n=n||"";let p=document.createElement("div"),m={},f={},v={};Object.defineProperty(m,"expression",{get(){let e={};for(let t in m){let i=m[t];"expression"!=t&&(e[i[0]]=i[1])}return e}}),Object.defineProperty(m,"urlids",{get(){let e=[];for(let t in v)e.push(v[t]);return e.join("")}});let h=document.createElement("div"),b=document.createElement("div"),x=document.createElement("div"),g=document.createElement("div"),y=document.createElement("div"),A=document.createElement("div");h.classList.add("menuAbas"),b.classList.add("abas"),g.classList.add("legenda"),x.classList.add("menuCompacto"),y.classList.add("background-1"),A.classList.add("background-2"),h.append(b),h.append(x),h.append(y),h.append(A),x.append(g),h.setAttribute("style",`--corFundoMenu: ${d};`),u&&h.classList.add("principal"),t.forEach((t,a)=>{!function(t,a,d){let c="m"+ ++o,u=document.createElement("div"),h=document.createElement("div"),b=document.createElement("div"),x=document.createElement("div"),g=document.createElement("div"),y=document.createElement("div"),A=document.createElement("div"),w=document.createElement("div"),C=d+2;m[a.varName]="",f[a.varName]="",v[a.varName]="";let E=[];function O(){u[l](),p.dispatchEvent(new e("input"))}u[l]=function(){let e=E.filter(e=>e.checked).map(e=>e.value),t=E.filter(e=>e.checked).map(e=>e[s].expression),i=E.filter(e=>e.checked).map(e=>e[s].urlid);m[a.varName]=[a.attrIndex,t],v[a.varName]=i.join(""),e.length?h.classList.add("selecionado"):h.classList.remove("selecionado");let n=e.join(" ou ");g.innerHTML=n,g.setAttribute("title",n),f[a.varName]=n},u.classList.add("itemMenuCompacto"),u.classList.add(a.varName),h.classList.add("titulo"),h.innerHTML=a.title,x.classList.add("valoresSelecionados"),g.classList.add("textoValoresSelecionados"),y.classList.add("icone"),y.innerHTML="expand_more",u.append(h),b.append(x),u.append(b),x.append(y),x.append(g),A.classList.add("submenu"),A.style["grid-column"]=C+"/"+(C+1),w.classList.add("itens"),w.classList.add("i"+d),w.classList.add("ABA"+i),A.append(w),u[r]=A,u.style["grid-column-start"]=C,u.addEventListener("click",e=>{if(u.classList.contains("aberto"))u.classList.remove("aberto"),A.classList.remove("aberto");else{let t=u.parentNode.querySelector(".aberto");t&&(t.classList.remove("aberto"),t[r].classList.remove("aberto")),u.classList.add("aberto"),A.classList.add("aberto")}});let _=null;a.itens.forEach((e,t)=>{let i=document.createElement("div"),o=document.createElement("label"),r=document.createElement("input");o.innerHTML=e.name,o.setAttribute("for",c+t),r.setAttribute("type",a.input),r.setAttribute("value",e.name),n.indexOf(e.urlid)>=0&&r.setAttribute("checked","checked"),r.setAttribute("id",c+t),r.setAttribute("name","radio"===a.input?c:c+t),r[s]=e,i.classList.add("item"),i.append(r),i.append(o),w.append(i),E.push(r),r.addEventListener("input",e=>{e.stopPropagation(),O()}),"radio"==a.input&&r.addEventListener("click",e=>{if(e.target===_){e.target.checked=!1,_=null,O();return}_=e.target})}),t.append(u),t.append(A),u[l]()}(x,t,a)});let w=p.attachShadow({mode:"open"});return w.append(function(){let e=document.createElement("style");return e.textContent=`                  
          div.menuAbas {
...
${t.map((e,t)=>i(e,t))}${t.length<a?n:""}`}function U(e,t,i,a,n,o,r,l,s,d,c,u,p,m){return e.select(t`
...
`).on("change",e=>{if(!a.map(e=>e.municipio).includes(document.getElementById("menu-municipios").value)&&!i.includes(document.getElementById("menu-municipios").value))return;let t=e.target.value;if(!(n.length==o||n.map(e=>e.nome).includes(t))){for(let f of(r.value=r.value.concat([{nome:t,cor:l.find(e=>!n.map(e=>e.cor).includes(e))}]),s))"PM25"==f.variavel&&i.includes(t)||Promise.all([d[f.variavel](t,"PM25"!=f.variavel?c.value.expression:null)]).then(e=>{u.value=u.value.concat({idx:f.i,municipio:t,variavel:f.variavel,dados:p[f.variavel](e[0])})});for(let v of[...new Set(m.filter(e=>e.filtrado).map(e=>e.idx))])Promise.all([d[s.find(e=>e.i==v).variavel](t,s.find(e=>e.i==v).filtros.value.expression)]).then(e=>{u.value=u.value.concat({idx:v,municipio:t,variavel:m.find(e=>e.idx==v).variavel,filtrado:!0,dados:p[m.find(e=>e.idx==v).variavel](e[0])})})}}).node()}function G(e,t,i,a,n,o,r){return(l,s)=>{let d=e.create("button").attr("class","btn-municipio").style("background-color",l.cor).style("display","inline-flex").style("align-items","flex-center").on("click",e=>{t.length>1&&(i.value=t.filter(e=>e!=l),a.value=n.filter(e=>e.municipio!=l.nome))});return o.includes(l.nome)?d.append("span").text(l.nome):d.append("span").text(l.nome+(l.nome.includes("(")?"":" ("+r.find(e=>e.municipio==l.nome).sigla+")")),d.append("span").attr("class","material-icons-outlined").style("font-size","16px").style("margin-left","5px").style("display",1==t.length?"none":"inline").text("remove_circle_outline"),d.node()}}function H(e,t){return()=>e.create("button").attr("class","btn-remove").text("–").on("click",t).attr("title","Eliminar trilha").node()}function V(e,t){return()=>{let i=e.create("button").attr("class","btn-remove").on("click",t);return i.append("span").attr("class","material-icons-outlined").style("font-size","10px").text("content_copy"),i.attr("title","Duplicar trilha"),i.node()}}function j(e,t,i,a){return{PM25:e,PESO:t,ROBSON:i,TOTAL:a}}function z(e,t,i,a){return{PM25:e,PESO:t,ROBSON:i,TOTAL:a}}function Z(e,t,i,a){return{PM25:e,PESO:t,ROBSON:i,TOTAL:a}}function J(e){return e`
...
</svg>`}function en(e,t,i,a,n,o,r,l,s,d,c,u,p,m,f,v,h,b,x,g,y,A,w,C,E,O,_,S){return M=>{let T=e.plot({marginTop:5,marginRight:0,width:t-65,height:i,x:{grid:!0,label:null,format:a,domain:n.find(e=>e.i==M).alterar_tempo?n.find(e=>e.i==M).alterar_tempo.map(e=>o[e].inicio):r.map(e=>o[e].inicio)},y:{grid:!0,domain:[0,l[s]],transform:e=>Math.min(122,e),label:null},marks:[e.rect([{y1:d[s][3],y2:l[s]}],{y1:"y1",y2:"y2",fill:"#FFEBEB"}),e.rect([{y1:d[s][2],y2:d[s][3]}],{y1:"y1",y2:"y2",fill:"#FFF5EB"}),e.rect([{y1:d[s][1],y2:d[s][2]}],{y1:"y1",y2:"y2",fill:"#FFFFED"}),n.find(e=>e.i==M).mostra_media_movel?c.filter(e=>e.idx==M&&!Object.values(u).includes(e.municipio)).map((t,i)=>e.line(t.dados.filter(e=>p(e,M)),e.windowY({strict:!0,k:m,anchor:"middle",x:"x",y:"valor",curve:"monotone-x",strokeWidth:f,stroke:v.find(e=>e.nome==t.municipio).cor}))):c.filter(e=>e.idx==M&&!Object.values(u).includes(e.municipio)).map((t,i)=>e.line(t.dados.filter(e=>p(e,M)),{x:"x",y:"valor",curve:"monotone-x",strokeWidth:f,stroke:v.find(e=>e.nome==t.municipio).cor})),e.ruleX([c.filter(e=>e.idx==M)[0].dados[h.center(c.filter(e=>e.idx==M)[0].dados,b)]],{x:"x",strokeDasharray:"5"}),n.find(e=>e.i==M).mostra_media_movel?null:c.filter(e=>e.idx==M).map((t,i)=>e.dot([t.dados[h.center(t.dados,b)]],{x:"x",y:"valor",fill:v.find(e=>e.nome==t.municipio).cor}))]});return x(T,"PM25",M),g(T),y`
...
<div class="trilha" i=${M}>
  <div class="cabecalho-trilha">
    ...
    <div class="opcoes-trilha">
    <label class="label-cabecalho-trilha">MODIFICAR PERÍODO</label> ${w.create("input").attr("type","checkbox").property("checked",n.find(e=>e.i==M).alterar_tempo).on("change",e=>_(e,M)).node()}
   </div>
...
</div>`}}function eo(e,t,i,a,n,o,r,l,s,d,c,u,p,m,f,v,h,b,x,g,y,A,w,C,E,O,_){return S=>{if(!e.map(e=>e.nome).every(e=>t.filter(e=>e.idx==S).map(e=>e.municipio).includes(e))||a.find(e=>e.i==S).filtros.value.expression&&a.find(e=>e.i==S).show_filtros&&t.filter(e=>e.idx==S).every(e=>void 0===e.filtrado)||n.value.expression&&t.filter(e=>e.idx==S).every(e=>void 0!==e.filtrado))return i();let M=o.plot({marginTop:5,marginRight:0,width:r-65,height:l,x:{grid:!0,label:null,domain:a.find(e=>e.i==S).alterar_tempo?a.find(e=>e.i==S).alterar_tempo.map(e=>s[e].inicio):d.map(e=>s[e].inicio)},y:{grid:!0,label:null},marks:[a.find(e=>e.i==S).mostra_media_movel?t.filter(e=>e.idx==S).map((t,i)=>o.line(t.dados.filter(e=>c(e,S)),o.windowY({strict:!0,k:u,anchor:"middle",x:"x",y:"valor",strokeWidth:t.filtrado?p:m,stroke:e.find(e=>e.nome==t.municipio).cor,strokeDasharray:t.filtrado?"3":"1"}))):t.filter(e=>e.idx==S).map((t,i)=>o.line(t.dados.filter(e=>c(e,S)),{sort:"x",x:"x",y:"valor",curve:"monotone-x",strokeWidth:t.filtrado?p:m,stroke:e.find(e=>e.nome==t.municipio).cor,strokeDasharray:t.filtrado?"3":"1"})),o.ruleX([t.filter(e=>e.idx==S)[0].dados[f.center(t.filter(e=>e.idx==S)[0].dados,v)]],{x:"x",strokeDasharray:"5"}),a.find(e=>e.i==S).mostra_media_movel?null:t.filter(e=>e.idx==S).map((t,i)=>o.dot([t.dados[f.center(t.dados,v)]],{x:"x",y:"valor",fill:e.find(e=>e.nome==t.municipio).cor}))]});return h(M,"PESO",S),b(M),x`
...
</div>`}}function er(e,t,i,a,n,o,r,l,s,d,c,u,p,m,f,v,h,b,x,g,y,A,w,C,E,O,_,S,M){return T=>{if(!e.map(e=>e.nome).every(e=>t.filter(e=>e.idx==T).map(e=>e.municipio).includes(e))||a.find(e=>e.i==T).filtros.value.expression&&a.find(e=>e.i==T).show_filtros&&t.filter(e=>e.idx==T).every(e=>void 0===e.filtrado)||n.value.expression&&t.filter(e=>e.idx==T).every(e=>void 0!==e.filtrado))return i();let I=a.find(e=>e.i==T).escala,R=a.find(e=>e.i==T).robson,N=o.plot({marginTop:5,marginRight:0,width:r-65,height:l,x:{grid:!0,label:null,domain:a.find(e=>e.i==T).alterar_tempo?a.find(e=>e.i==T).alterar_tempo.map(e=>s[e].inicio):d.map(e=>s[e].inicio)},y:{grid:!0,label:null},marks:[a.find(e=>e.i==T).mostra_media_movel?t.filter(e=>e.idx==T).map((t,i)=>o.line(t.dados.filter(e=>c(e,T)),o.windowY({strict:!0,k:u,anchor:"middle",x:"x",y:e=>e[I][R],strokeWidth:t.filtrado?p:m,stroke:e.find(e=>e.nome==t.municipio).cor,strokeDasharray:t.filtrado?"3":"1"}))):t.filter(e=>e.idx==T).map((t,i)=>o.line(t.dados.filter(e=>c(e,T)),{sort:"x",x:"x",y:e=>e[I][R],curve:"monotone-x",strokeWidth:t.filtrado?p:m,stroke:e.find(e=>e.nome==t.municipio).cor,strokeDasharray:t.filtrado?"3":"1"})),o.ruleX([t.filter(e=>e.idx==T)[0].dados[f.center(t.filter(e=>e.idx==T)[0].dados,v)]],{x:"x",strokeDasharray:"5"}),a.find(e=>e.i==T).mostra_media_movel?null:t.filter(e=>e.idx==T).map((t,i)=>o.dot([t.dados[f.center(t.dados,v)]],{x:"x",y:e=>e[I][R],fill:e.find(e=>e.nome==t.municipio).cor}))]});h(N,"ROBSON",T,I,R),b(N);let L;return x`
...
<div class="trilha" i=${T}>
  <div class="cabecalho-trilha">
    ...
    ${(L=y.create("select").attr("class","menuIG")).style("font-family","Roboto Condensed"),L.append("option").attr("name","Robson1a4").text("Robson1a4").property("selected","Robson1a4"==a.find(e=>e.i==T).robson),L.append("option").attr("name","Robson5").text("Robson5").property("selected","Robson5"==a.find(e=>e.i==T).robson),L.append("option").attr("name","Robson6a10").text("Robson6a10").property("selected","Robson6a10"==a.find(e=>e.i==T).robson),L.on("change",e=>C(e,T)),L.node()}
    <div class="opcoes-trilha">
    ...
    <label class="label-cabecalho-trilha">MODIFICAR PERÍODO</label> ${y.create("input").attr("type","checkbox").property("checked",a.find(e=>e.i==T).alterar_tempo).on("change",e=>O(e,T)).node()}
    </div>
    <div class="opcoes-trilha">
    ...
    ${y.create("input").attr("type","radio").attr("name","escala_"+T).property("checked","taxa"==a.find(e=>e.i==T).escala).attr("value","taxa").on("change",e=>_(e,T)).node()}
    </div>
    <span class="fonte">Fonte: SINASC</span>
  </div>
...
<div class="rodape-trilha">
<div class="botao-comparacao">
${y.create("input").attr("type","checkbox").property("checked",a.find(e=>e.i==T).show_filtros).on("change",e=>M(e,T)).node()}
<label>COMPARAÇÃO</label>
</div>
...
</div>`}}function el(e,t,i,a,n,o,r,l,s,d,c,u,p,m,f,v,h,b,x,g,y,A,w,C,E,O,_,S){return M=>{if(!e.map(e=>e.nome).every(e=>t.filter(e=>e.idx==M).map(e=>e.municipio).includes(e))||a.find(e=>e.i==M).filtros.value.expression&&a.find(e=>e.i==M).show_filtros&&t.filter(e=>e.idx==M).every(e=>void 0===e.filtrado)||n.value.expression&&t.filter(e=>e.idx==M).every(e=>void 0!==e.filtrado))return i();let T=a.find(e=>e.i==M).escala,I=o.plot({marginTop:5,marginRight:0,width:r-65,height:l,x:{grid:!0,label:null,domain:a.find(e=>e.i==M).alterar_tempo?a.find(e=>e.i==M).alterar_tempo.map(e=>s[e].inicio):d.map(e=>s[e].inicio)},y:{grid:!0,label:null},marks:[a.find(e=>e.i==M).mostra_media_movel?t.filter(e=>e.idx==M).map((t,i)=>o.line(t.dados.filter(e=>c(e,M)),o.windowY({strict:!0,k:u,anchor:"middle",x:"x",y:e=>e[T],strokeWidth:t.filtrado?p:m,stroke:e.find(e=>e.nome==t.municipio).cor,strokeDasharray:t.filtrado?"3":"1"}))):t.filter(e=>e.idx==M).map((t,i)=>o.line(t.dados.filter(e=>c(e,M)),{sort:"x",x:"x",y:e=>e[T],curve:"monotone-x",strokeWidth:t.filtrado?p:m,stroke:e.find(e=>e.nome==t.municipio).cor,strokeDasharray:t.filtrado?"3":"1"})),o.ruleX([t.filter(e=>e.idx==M)[0].dados[f.center(t.filter(e=>e.idx==M)[0].dados,v)]],{x:"x",strokeDasharray:"5"}),a.find(e=>e.i==M).mostra_media_movel?null:t.filter(e=>e.idx==M).map((t,i)=>o.dot([t.dados[f.center(t.dados,v)]],{x:"x",y:e=>e[T],fill:e.find(e=>e.nome==t.municipio).cor}))]});return h(I,"TOTAL",M,T),b(I),x`
...
<div class="trilha" i=${M}>
  <div class="cabecalho-trilha">
    ...
    <div class="opcoes-trilha">
    <label class="label-cabecalho-trilha">MODIFICAR PERÍODO</label> ${y.create("input").attr("type","checkbox").property("checked",a.find(e=>e.i==M).alterar_tempo).on("change",e=>E(e,M)).node()}
    </div>
    <div class="opcoes-trilha">
    <label class="label-cabecalho-trilha">ESCALA ABSOLUTO</label>
...
<div class="rodape-trilha">
<div class="botao-comparacao">
${y.create("input").attr("type","checkbox").property("checked",a.find(e=>e.i==M).show_filtros).on("change",e=>S(e,M)).node()}
<label>COMPARAÇÃO</label>
</div>
...
${("ROBSON"!=h?t.filter(e=>!e.filtrado&&e.idx==m&&(!Object.values(l).includes(e.municipio)||"PM25"!=h)).sort((e,t)=>s.findIndex(e=>e.nome==t.municipio)-s.findIndex(t=>t.nome==e.municipio)):t.filter(e=>!e.filtrado&&e.idx==m).sort((e,t)=>s.findIndex(e=>e.nome==t.municipio)-s.findIndex(t=>t.nome==e.municipio))).map(e=>"<span class='valor' style='color:"+s.find(t=>t.nome==e.municipio).cor+";'>"+("ROBSON"!=h?e.dados[d.center(e.dados,o)][f].toFixed("percentual"==f||"taxa"==f?3:0):e.dados[d.center(e.dados,o)][f][v].toLocaleString("pt-BR",{maximumFractionDigits:"percentual"==f?3:"taxa"==f?2:0}))+"</span>")}
</div>
...
${("ROBSON"!=h?t.filter(e=>e.idx==m&&(!Object.values(l).includes(e.municipio)||"PM25"!=h)).sort((e,t)=>t.dados[d.center(t.dados,o)][f]-e.dados[d.center(e.dados,o)][f]):t.filter(e=>e.idx==m).sort((e,t)=>t.dados[d.center(t.dados,o)][f][v]-e.dados[d.center(e.dados,o)][f][v])).map(e=>"<span class='valor' style='color:"+s.find(t=>t.nome==e.municipio).cor+";'>"+("ROBSON"!=h?e.dados[d.center(e.dados,o)][f].toFixed("percentual"==f||"taxa"==f?3:0):e.dados[d.center(e.dados,o)][f][v].toLocaleString("pt-BR",{maximumFractionDigits:"percentual"==f?3:"taxa"==f?2:0}))+" "+u[h][f]+"</span>")}
</div>
<div>
<center>
...
</div>`}function eu(e,t,i,a,n,o){return r=>{let l=e.findIndex(e=>e.i==r.target.parentNode.parentNode.getElementsByClassName("trilha")[0].getAttribute("i")),s={...e[l]},d=t.max(e.map(e=>e.i))+1;s.i=d,"PM25"!=s.variavel&&(s.filtros=s.filtros.cloneMenu(),s.filtros.addEventListener("input",e=>i(e,s))),e.splice(l+1,0,s),a.value=e;let c=JSON.parse(JSON.stringify(n.filter(e=>e.idx==r.target.parentNode.parentNode.getElementsByClassName("trilha")[0].getAttribute("i"))));c.forEach((e,t,i)=>{i[t].idx=d,i[t].dados.forEach((e,t,i)=>i[t].x=new Date(i[t].x))}),o.value=n.concat(c)}}function ep(e,t,i,a){return n=>{e.value=t.filter(e=>e.i!=n.target.parentNode.parentNode.getElementsByClassName("trilha")[0].getAttribute("i")),i.value=a.filter(e=>e.idx!=n.target.parentNode.parentNode.getElementsByClassName("trilha")[0].getAttribute("i"))}}function em(e,t,i,a,n,o,r,l,s,d,c,u,p,m,f,v){return h=>{let b=e.max(t.map(e=>e.i))||0,x=null;switch(h.target.value){case"POLUENTE":x={i:b+1,mostra_media_movel:!0,variavel:"PM25",alterar_tempo:null,poluente:"PM25"},i.value=t.concat(x),a.forEach(e=>Promise.all([n(e.nome)]).then(t=>{o.value=o.value.concat([{idx:b+1,municipio:e.nome,variavel:"PM25",dados:r(t[0])}])}));break;case"PESO AO NASCER":(x={i:b+1,mostra_media_movel:!1,variavel:"PESO",alterar_tempo:null,filtros:new l.local(null,null,s.PESO),show_filtros:!1}).filtros.addEventListener("input",e=>d(e,x)),i.value=t.concat(x),a.forEach(e=>Promise.all([c(e.nome,x.filtros.expression)]).then(t=>{o.value=o.value.concat([{idx:b+1,municipio:e.nome,variavel:"PESO",dados:u(t[0])}])}));break;case"GRUPOS DE ROBSON":(x={i:b+1,mostra_media_movel:!1,escala:"taxa",robson:"Robson1a4",variavel:"ROBSON",alterar_tempo:null,filtros:new l.local(null,null,s.ROBSON),show_filtros:!1}).filtros.addEventListener("input",e=>d(e,x)),i.value=t.concat(x),a.forEach(e=>Promise.all([p(e.nome,x.filtros.expression)]).then(t=>{o.value=o.value.concat([{idx:b+1,municipio:e.nome,variavel:"ROBSON",dados:m(t[0])}])}));break;case"NASCIMENTOS TOTAIS":(x={i:b+1,mostra_media_movel:!1,variavel:"TOTAL",alterar_tempo:null,filtros:new l.local(null,null,s.TOTAL),show_filtros:!1,escala:"absoluto"}).filtros.addEventListener("input",e=>d(e,x)),i.value=t.concat(x),a.forEach(e=>Promise.all([f(e.nome,x.filtros.expression)]).then(t=>{o.value=o.value.concat([{idx:b+1,municipio:e.nome,variavel:"TOTAL",dados:v(t[0])}])}))}}}function ef(e,t,i,a){return n=>{if(!e.find(e=>e.i==n).alterar_tempo)return"";let o=t(104,468,e.find(e=>e.i==n).alterar_tempo[0],e.find(e=>e.i==n).alterar_tempo[1],i-90,40);return o.addEventListener("input",t=>{let i=e;i.find(e=>e.i==n).alterar_tempo=o.value,a.value=i}),o}}function ev(e,t){return i=>{e.find(e=>e.i==i.target.parentElement.parentElement.getAttribute("i")).poluente=i.target.value,t.value=e}}function eh(e,t,i,a,n,o,r,l,s,d){return(c,u)=>{if(e.find(e=>e.i==u).show_filtros=c.target.checked,c.target.checked){let p=e.find(e=>e.i==u);p.filtros=new i.local(null,a.value.urlids,n[p.variavel]),p.filtros.addEventListener("input",e=>o(e,p)),t.value=t.value.filter(e=>e.idx!=u||!e.filtrado),r.value.forEach(i=>{Promise.all([l[e.find(e=>e.i==u).variavel](i.nome,e.find(e=>e.i==u).filtros.value.expression)]).then(a=>{t.value=t.value.concat({idx:u,municipio:i.nome,variavel:e.find(e=>e.i==u).variavel,filtrado:!0,dados:s[e.find(e=>e.i==u).variavel](a[0])})})})}else t.value=t.value.filter(e=>e.idx!=u||!e.filtrado);d.value=e}}function eb(e,t,i){return(a,n)=>{a.target.checked?e.find(e=>e.i==n).alterar_tempo=t:e.find(e=>e.i==n).alterar_tempo=null,i.value=e}}function ex(e,t){return(i,a)=>{e.find(e=>e.i==a).robson=i.target.value,t.value=e}}function eg(e,t){return(i,a)=>{e.find(e=>e.i==a).escala=i.target.value,t.value=e}}function ey(e,t){return(i,a)=>{e.find(e=>e.i==a).mostra_media_movel=i.target.checked,t.value=e}}function eA(e){return t=>{let i=[0,0];return i[0]=e[t[0]].inicio,i[1]=e[t[1]].termino,i}}function ew(){return""}function eC(e,t,i){return e?e.trilhas.map(e=>(e.filtros=new t.local(null,e.filtrosUrlids),e)):[{i:0,mostra_media_movel:!0,variavel:"PM25",alterar_tempo:null,poluente:"PM25"},{i:1,mostra_media_movel:!1,variavel:"PESO",alterar_tempo:null,filtros:new t.local(null,null,i.PESO),show_filtros:!1},{i:2,mostra_media_movel:!1,escala:"taxa",robson:"Robson1a4",variavel:"ROBSON",alterar_tempo:null,filtros:new t.local(null,null,i.ROBSON),show_filtros:!1}]}function eE(){return{PM25:{valor:"\xb5g/m\xb3"},PESO:{valor:"g"},ROBSON:{absoluto:"nascimentos",percentual:"%",taxa:"nasc./1000NV"},TOTAL:{absoluto:"nascimentos",percentual:"%"}}}function eO(){return 2.5}function e_(){return 2}function eS(){return!0}function eM(e,t){return e?e.municipios:t.municipios}function eT(e,t,i,a,n,o,r,l,s,d,c,u,p,m){if(e){for(let f of t.value)i.value=i.value.concat([f]),f=f.nome,a.forEach(e=>{Promise.all([n[e.variavel](f,o.value.expression)]).then(t=>{r.value=r.value.concat({idx:e.i,municipio:f,variavel:e.variavel,dados:l[e.variavel](t[0])})}),e.show_filtros&&Promise.all([n[e.variavel](f,e.filtros.value.expression)]).then(t=>{r.value=r.value.concat({idx:e.i,municipio:f,variavel:e.variavel,filtrado:!0,dados:l[e.variavel](t[0])})})}),a.slice(1).forEach(e=>e.filtros.addEventListener("input",t=>s(t,e)));o.addEventListener("input",e=>d(e)),o.addEventListener("aba",e=>{c.setItem("conf2",JSON.stringify(u())),c.setItem("municipios",JSON.stringify(i.value)),c.setItem("intervalo",JSON.stringify(p.value))}),m.value=!1}}function eI(e,t,i,a){return(n,o)=>{e.value=e.value.filter(e=>e.idx!=o.i||!e.filtrado),t.value.forEach(t=>{Promise.all([i[o.variavel](t.nome,o.filtros.value.expression)]).then(i=>{e.value=e.value.concat({idx:o.i,municipio:t.nome,variavel:o.variavel,filtrado:!0,dados:a[o.variavel](i[0])})})})}}function eR(e){return e.range([3,53],{label:"Janela em semanas",value:13,step:2})}function eN(e){return e.select(["co_ppb","no2_ppb","o3_ppb","pm25_ugm3","so2_ugm3"],{label:"Indicador",value:"pm25_ugm3"})}function eL(){return["#2F87F5","#D8C56C","#DC5988","#6CC28D","#67AEC2","#ABA6F8","#D8C56C","#2DE8BD","#2F87F5","#94E8F9"]}function ek(){return[]}function eD(){return[]}function eP(e,t,i,a){return e[Math.ceil(t.interpolate(...i?i.intervalo:a.intervalo)(.5))].inicio}function eF(e){return e.bisector(e=>e.x)}function eB(e){return e.timeFormatDefaultLocale({decimal:",",thousands:".",grouping:[3],currency:["$",""],dateTime:"%a %b %e %X %Y",date:"%d/%m/%Y",time:"%H:%M:%S",periods:["AM","PM"],days:["Domingo","Segunda-feira","Ter\xe7a-feira","Quarta-feira","Quinta-feira","Sexta-feira","S\xe1bado"],shortDays:["Dom","Seg","Ter","Qua","Qui","Sex","Sab"],months:["Janeiro","Fevereiro","Mar\xe7o","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"],shortMonths:["Jan","Fev","Mar","Abr","Mai","Jun","Jul","Ago","Set","Out","Nov","Dez"]})}function e$(e){return function(t){let i=[];return t.forEach((a,n)=>{if(n<~~(e/2)||n>t.length-~~(e/2)-1)return;let o=0;for(let r=-~~(e/2);r<=~~(e/2);r++)o+=t[n-r].TOTAL;i.push({x:a.x,TOTAL:o/e})}),i}}function eU(e){return e[0]}function eG(e){return e[1]}function eH(e,t,i,a,n){return(o,r)=>{let l=e.find(e=>e.i==r).alterar_tempo,s=e.find(e=>e.i==r).mostra_media_movel?(t-1)/2:0;return l?o.x.getTime()>=i[l[0]-s].inicio.getTime()&&o.x.getTime()<=i[l[1]+s].termino.getTime():o.x.getTime()>=i[a-s].inicio.getTime()&&o.x.getTime()<=i[n+s].termino.getTime()}}function eV(){return 200}function ej(){return!0}function ez(e,t,i){return function(a,n){if(2==a.length)return;e.value=!0;let o=t.find(e=>e.municipio==a).codigo_sdv,r=`https://storage.googleapis.com/amplia/sisam/${o.substring(0,2)}/mun${o}.db`,l=i.open(r).then(e=>e.query(n));return e.value=!1,l}}function eZ(e){return e`<style>
  @import url('https://fonts.googleapis.com/css2?family=Fira+Sans+Condensed:wght@400;700&display=swap');
  text{
    font-family:"Fira Sans Condensed"
  }
</style>`}function eJ(e){return e("municipios2.csv").csv()}function eq(e){return e("semanas_epidemiologicas_estendido.csv").csv().then(e=>e.map(e=>(e.inicio=new Date(Date.UTC(+e.inicio.substr(0,4),+e.inicio.substr(5,2)-1,+e.inicio.substr(8,2))),e.termino=new Date(Date.UTC(+e.termino.substr(0,4),+e.termino.substr(5,2)-1,+e.termino.substr(8,2))),e)).filter(e=>e.ano>=2010))}function eW(){return{ACRE:"RIO BRANCO",ALAGOAS:"MACEI\xd3",AMAPÁ:"MACAP\xc1",AMAZONAS:"MANAUS",BAHIA:"SALVADOR",CEARÁ:"FORTALEZA","DISTRITO FEDERAL":"BRAS\xcdLIA","ESP\xcdRITO SANTO":"VIT\xd3RIA",GOIÁS:"GOI\xc2NIA",MARANHÃO:"S\xc3O LU\xcdS","MATO GROSSO":"CUIAB\xc1","MATO GROSSO DO SUL":"CAMPO GRANDE","MINAS GERAIS":"BELO HORIZONTE",PARÁ:"BEL\xc9M",PARAÍBA:"JO\xc3O PESSOA",PARANÁ:"CURITIBA",PERNAMBUCO:"RECIFE",PIAUÍ:"TERESINA","RIO DE JANEIRO":"RIO DE JANEIRO","RIO GRANDE DO NORTE":"NATAL","RIO GRANDE DO SUL":"PORTO ALEGRE",RONDÔNIA:"PORTO VELHO",RORAIMA:"BOA VISTA","SANTA CATARINA":"FLORIAN\xd3POLIS","S\xc3O PAULO":"S\xc3O PAULO",SERGIPE:"ARACAJU",TOCANTINS:"PALMAS"}}function eX(){return{ACRE:"AC",ALAGOAS:"AL",AMAPÁ:"AP",AMAZONAS:"AM",BAHIA:"BA",CEARÁ:"CE","DISTRITO FEDERAL":"DF","ESP\xcdRITO SANTO":"ES",GOIÁS:"GO",MARANHÃO:"MA","MATO GROSSO":"MT","MATO GROSSO DO SUL":"MS","MINAS GERAIS":"MG",PARÁ:"PA",PARAÍBA:"PB",PARANÁ:"PR",PERNAMBUCO:"PE",PIAUÍ:"PI","RIO DE JANEIRO":"RJ","RIO GRANDE DO NORTE":"RN","RIO GRANDE DO SUL":"RS",RONDÔNIA:"RO",RORAIMA:"RR","SANTA CATARINA":"SC","S\xc3O PAULO":"SP",SERGIPE:"SE",TOCANTINS:"TO"}}function eQ(){return[]}function eY(){return[]}function eK(){return["JAN","FEV","MAR","ABR","MAI","JUN","JUL","AGO","SET","OUT","NOV","DEZ"]}function e0(e){return Object.values(e).sort(Intl.Collator().compare)}function e1(e){return t=>"BRASIL"==t?"":e.includes(t)?"AND res_SIGLA_UF='"+t+"'":"AND res_MUNNOMEX='"+t.normalize("NFD").replace(/\p{Diacritic}/gu,"")+"'"}function e2(e,t,i){return a=>"BRASIL"==a?"":e.includes(a)?"mun_uf_nome='"+Object.entries(t).find(e=>e[1]==a)[0]+"'":"mun_geocodsdv="+i.find(e=>e.municipio==a).codigo_sdv}function e5(e){return e`## URL stuff`}function e3(e){return function(t){return e.compressToEncodedURIComponent(JSON.stringify(t))}}function e4(e){return function(t){return JSON.parse(e.decompressFromEncodedURIComponent(t))}}function e7(e,t,i,a){return()=>({principalUrlids:e.value.value.urlids,municipios:t.value,intervalo:i,trilhas:a.value.map(e=>{let t={};return Object.assign(t,e),t.filtros&&(t.filtrosUrlids=t.filtros.value.urlids,delete t.filtros),t})})}function e6(){return{principalUrlids:"",municipios:[{nome:"RIO DE JANEIRO",cor:"#2F87F5"}],intervalo:[104,469],trilhas:[{i:0,mostra_media_movel:!0,variavel:"PM25",alterar_tempo:null,poluente:"PM25"},{i:1,mostra_media_movel:!1,variavel:"PESO",alterar_tempo:null,show_filtros:!1,filtrosUrlids:""},{i:2,mostra_media_movel:!1,escala:"taxa",robson:"Robson1a4",variavel:"ROBSON",alterar_tempo:null,show_filtros:!1,filtrosUrlids:""}]}}function e8(e,t,i,a){let n=new e(window.location.search).get("conf");if(n)return t(n);if(n=i.getItem("conf2")){let o=JSON.parse(n),r=i.getItem("municipios");r&&(o.municipios=JSON.parse(r));let l=i.getItem("intervalo");return l&&(o.intervalo=JSON.parse(l)),o}if(n=i.getItem("municipios")){let s=a;return s.municipios=JSON.parse(n),n=i.getItem("intervalo"),s.intervalo=JSON.parse(n),s}}function e9(){return function(e){var t=document.body.appendChild(document.createElement("textarea"));t.style.position="absolute",t.style.left="-9999px",t.setAttribute("readonly",""),t.value=e,t.select();try{return document.execCommand("copy")}catch(i){return!1}finally{t.parentNode.removeChild(t)}}}function te(){return"https://ampliasaude.github.io/trilhas5-2.html"}function tt(e,t,i,a,n){return()=>{let o=e`<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M6.045 10C6.045 11.026 6.8095 11.86 7.75 11.86H9.95V13H7.75C6.232 13 5 11.656 5 10C5 8.344 6.232 7 7.75 7H9.95V8.14H7.75C6.8095 8.14 6.045 8.974 6.045 10ZM8.3 9.4H12.7V10.6H8.3V9.4ZM13.25 13H11.05V11.86H13.25C14.1905 11.86 14.955 11.026 14.955 10C14.955 8.974 14.1905 8.14 13.25 8.14H11.05V7H13.25C14.768 7 16 8.344 16 10C16 11.656 14.768 13 13.25 13Z" fill="white"/>
</svg>`;return o.onclick=()=>{n(`${t}?conf=${i(a())}`)},o}}function ti(e){return e`## Poluentes`}function ta(){return{pm25_ugm3:120,so2_ugm3:90,no2_ppb:286,o3_ppb:154,co_ppb:9.9}}function tn(){return e=>.08206*(e+293.15)}function to(){return{no2_ppb:46.0055,o3_ppb:48,co_ppb:28.01}}function tr(){return{pm25_ugm3:[25,37,50,60],so2_ugm3:[20,30,40,60],no2_ppb:[200,220,240,260],o3_ppb:[100,120,130,140],co_ppb:[9,9,9,9]}}function tl(e,t){return(i,a="TRUE")=>t(i,`
      select 
        ano,
        mes,
        dia,
      ...
      group by
        1,2,3
 `)}function ts(e,t,i,a){return n=>{n.forEach(n=>{let o=n,r=new Date(Date.UTC(o.ano,o.mes-1,o.dia));for(let l of e)if(r>=new Date(l.inicio)&&r<=new Date(l.termino)){o.semana=+l.semana,o.x=l.inicio;break}switch(1==o.mes&&53==o.semana&&(o.ano-=1,o.mes=12),t){case"no2_ppb":case"o3_ppb":let s=i[t]/a(o.temperatura);o.valor*=s;case"co_ppb":o.valor/=1e3}});let o=[];for(let r of n){let l=o.find(e=>e.x==r.x);l?(l.valor+=r.valor,l.temperatura_c_media+=r.temperatura_c_media,l.cont+=1):o.push({ano:r.ano,semana:r.semana,x:r.x,valor:r.valor||0,temperatura_c_media:r.temperatura_c_media,cont:1})}return o.map(e=>(e.valor/=e.cont,e.temperatura_c_media/=e.cont,delete e.cont,e)).filter(e=>e.semana)}}function td(e){return e`## Fecundação`}function tc(e,t,i){return async(a,n)=>{let o;return await i.fetchPeso(e.includes(a)?Math.floor(t.find(e=>e.sigla==a).codigo_sdv/1e4):t.find(e=>e.municipio==a).codigo_sdv,n)}}function tu(e){return t=>{t.forEach(t=>{let i=t;for(let a of(i.data=new Date(i.data),e))if(i.data>=new Date(a.inicio)&&i.data<=new Date(a.termino)){i.x=a.inicio;break}});let i=[];for(let a of t){let n=i.find(e=>e.x.getTime()==a.x.getTime());n?(n.valor+=a.valor*a.total,n.total+=a.total):i.push({x:a.x,valor:a.valor*a.total,total:a.total})}return i.map(e=>(e.valor/=e.total,delete e.total,e)).filter(e=>e.x)}}function tp(e,t,i){return async(a,n)=>{let o;return await i.fetchRobson(e.includes(a)?Math.floor(t.find(e=>e.sigla==a).codigo_sdv/1e4):t.find(e=>e.municipio==a).codigo_sdv,n)}}function tm(e,t){return i=>{let a=e(i[1]);(i=i[0]).forEach(e=>{let i=e;for(let a of(i.data=new Date(i.data),t))if(i.data>=new Date(a.inicio)&&i.data<=new Date(a.termino)){i.x=a.inicio;break}});let n=i,o=[];for(let r of n){let l=o.find(e=>e.x.getTime()==r.x.getTime());l?(l.absoluto[r.robson]+=r.total,l.total+=r.total):o.push({x:r.x,absoluto:{Robson1a4:"Robson1a4"==r.robson?r.total:0,Robson5:"Robson5"==r.robson?r.total:0,Robson6a10:"Robson6a10"==r.ig?r.total:0},total:r.total})}return t.filter(e=>!o.map(e=>e.x.getTime()).includes(e.inicio.getTime())).forEach(e=>{o.push({x:e.inicio,absoluto:{Robson1a4:0,Robson5:0,Robson6a10:0},total:0})}),(o=o.map(e=>{e.percentual={},e.total?(e.percentual.Robson1a4=100*e.absoluto.Robson1a4/e.total,e.percentual.Robson5=100*e.absoluto.Robson5/e.total,e.percentual.Robson6a10=100*e.absoluto.Robson6a10/e.total):(e.percentual.Robson1a4=0,e.percentual.Robson5=0,e.percentual.Robson6a10=0),e.taxa={};let t=a.find(t=>t.x.getTime()==e.x.getTime());return t?(e.taxa.Robson1a4=1e3*e.absoluto.Robson1a4/t.valor,e.taxa.Robson5=1e3*e.absoluto.Robson5/t.valor,e.taxa.Robson6a10=1e3*e.absoluto.Robson6a10/t.valor):(e.taxa.Robson1a4=0,e.taxa.Robson5=0,e.taxa.Robson6a10=0),e})).sort((e,t)=>e.x.getTime()-t.x.getTime())}}function tf(e){return t=>{let i=[];t.forEach(t=>{let a=t;if(a.data=new Date(a.data),!(2011>a.data.getFullYear())){for(let n of e)if(a.data>=new Date(n.inicio)&&a.data<=new Date(n.termino)){a.x=n.inicio;break}i.push(a)}});let a=[];for(let n of i){let o=a.find(e=>e.x.getTime()==n.x.getTime());o?o.valor+=n.valor:a.push({x:n.x,valor:n.valor})}return a.filter(e=>e.x)}}function tv(e,t,i){return async(a,n)=>{let o;return await i.fetchTotal(e.includes(a)?Math.floor(t.find(e=>e.sigla==a).codigo_sdv/1e4):t.find(e=>e.municipio==a).codigo_sdv,n)}}function th(e,t){return i=>{let a=e(i[1]);i=i[0];let n=[];i.forEach(e=>{let i=e;if(i.data=new Date(i.data),!(2011>i.data.getFullYear())){for(let a of t)if(i.data>=new Date(a.inicio)&&i.data<=new Date(a.termino)){i.x=a.inicio;break}n.push(i)}});let o=[];for(let r of n){let l=o.find(e=>e.x.getTime()==r.x.getTime());l?l.absoluto+=r.valor:o.push({x:r.x,absoluto:r.valor})}return(o=o.filter(e=>e.x)).map(e=>{e.percentual={};let t=a.find(t=>t.x.getTime()==e.x.getTime());return t?e.percentual=100*e.absoluto/t.valor:e.percentual=0,e})}}function tb(e){return e`## Imports`}function tx(e){return e("sortablejs/Sortable.js")}function tg(e){return e("d3@5")}function ty(e,t,i,a,n,o,r){return function(l,s,d=l,c=s,u=e.width,p=60){var m=[l,s+1],f=e.height,v=e.margin,h=u-p-v.right,b=f-v.top-v.bottom,x=t.scaleLinear().domain(m).range([0,h]),g=t.select(i.svg(u,f));let y=g.append("g").attr("transform",`translate(${p}, ${v.top})`);var A=y.append("text").attr("id","labelleft").attr("x",0).attr("y",b+5).style("display",60==p?"inline":"none").text(a[n[m[0]].inicio.getMonth()]+" "+n[m[0]].inicio.getFullYear()),w=y.append("text").attr("id","labelright").attr("x",0).attr("y",b+5).style("display",60==p?"inline":"none").text(a[n[m[1]].termino.getMonth()]+" "+n[m[1]].termino.getFullYear());y.append("text").attr("id","labelleft2").attr("x",-8).attr("y",b-b/2+1).style("alignment-baseline","middle").text(2012),y.append("text").attr("id","labelright2").attr("x",h+8).attr("y",b-b/2+1).style("alignment-baseline","middle").text(2019);var C=t.brushX().extent([[0,0],[h,b]]).on("brush",function(){var e=t.event.selection;A.attr("x",e[0]).text(a[n[Math.round(x.invert(e[0]))].inicio.getMonth()]+" "+n[Math.round(x.invert(e[0]))].inicio.getFullYear()),w.attr("x",e[1]).text(a[n[Math.round(x.invert(e[1]))].termino.getMonth()]+" "+n[Math.round(x.invert(e[1]))].termino.getFullYear()),_.attr("display",null).attr("transform",function(t,i){return"translate("+[e[i],-b/4]+")"}),g.node().value=e.map(e=>Math.round(x.invert(e))),g.node().dispatchEvent(new CustomEvent("input"))}).on("end",function(){if(t.event.sourceEvent){var e=t.event.selection.map(x.invert).map(Math.round);t.select(this).transition().call(t.event.target.move,e.map(x)),o.value=Math.max(Math.min(new Date(o.value),n[g.node().value[1]-2].termino),n[g.node().value[0]].inicio)}}),E=y.append("g").attr("class","brush").call(C),O=function(e){return"M -3 12 A 3 3 0 0 1 3 12 V 18 A 3 3 0 0 1 -3 18 Z"},_=E.selectAll(".handle--custom").data([{type:"w"},{type:"e"}]).enter().append("path").attr("class","handle--custom").attr("stroke","#000").attr("fill","#151472").attr("cursor","ew-resize").attr("y",b/2).attr("d",O);return E.selectAll(".overlay").attr("fill","#E5E5E5").each(function(e){e.type="selection"}).on("mousedown touchstart",function(){var e=x(1)-x(0),t=r.mouse(this)[0],i=t-e/2,a=t+e/2;r.select(this.parentNode).call(C.move,a>h?[h-e,h]:i<0?[0,e]:[i,a])}),E.call(C.move,[d,c+1].map(x)),y.append("g").selectAll("line").data(n.filter(e=>1==e.semana).map(e=>n.findIndex(t=>t==e))).enter().append("line").attr("x1",e=>x(e)).attr("x2",e=>x(e)).attr("y1",0).attr("y2",b).style("stroke","#ccc"),g.node()}}function tA(){return{width:600,height:60,margin:{top:20,bottom:20,left:60,right:60}}}function tw(e){return e`
<style>
@import url('https://fonts.googleapis.com/css2?family=Roboto+Condensed:wght@400;700&display=swap');
svg {
	font-family: "Roboto Condensed";
...
`}function tC(e){return e("https://bundle.run/lz-string@1.4.4")}function tE(e){return e`<style>
  @import url(https://fonts.googleapis.com/css2?family=Roboto+Condensed:wght@300;400;700&display=swap);
  @import url(https://fonts.googleapis.com/icon?family=Material+Icons);    
</style>
`}function tO(e,t,i){return e`
...
`}function tS(e){var t,i,a,n,o,r,l,s,d;for(i=0,n=(t=document.getElementsByClassName("custom-select")).length;i<n;i++){for(o=(r=t[i].getElementsByTagName("select")[0]).length,(l=document.createElement("DIV")).setAttribute("class","select-selected"),l.innerHTML=r.options[r.selectedIndex].innerHTML,t[i].appendChild(l),(s=document.createElement("DIV")).setAttribute("class","select-items select-hide"),a=1;a<o;a++)(d=document.createElement("DIV")).innerHTML=r.options[a].innerHTML,d.addEventListener("click",function(e){var t,i,a,n,o,r,l;for(i=0,r=(n=this.parentNode.parentNode.getElementsByTagName("select")[0]).length,o=this.parentNode.previousSibling;i<r;i++)if(n.options[i].innerHTML==this.innerHTML){for(a=0,n.selectedIndex=i,o.innerHTML=this.innerHTML,l=(t=this.parentNode.getElementsByClassName("same-as-selected")).length;a<l;a++)t[a].removeAttribute("class");this.setAttribute("class","same-as-selected");break}o.click()}),s.appendChild(d);t[i].appendChild(s),l.addEventListener("click",function(e){e.stopPropagation(),c(this),this.nextSibling.classList.toggle("select-hide"),this.classList.toggle("select-arrow-active")})}function c(e){var t,i,a,n,o,r=[];for(a=0,t=document.getElementsByClassName("select-items"),i=document.getElementsByClassName("select-selected"),n=t.length,o=i.length;a<o;a++)e==i[a]?r.push(a):i[a].classList.remove("select-arrow-active");for(a=0;a<n;a++)r.indexOf(a)&&t[a].classList.add("select-hide")}document.addEventListener("click",c)}function tM(e,t){let a=e.module();function n(){return this.url}let o=new Map([["semanas_epidemiologicas_estendido.csv",{url:new i.U(i(3656)),mimeType:"text/csv",toString:n}],["municipios2.csv",{url:new i.U(i(474)),mimeType:"text/csv",toString:n}]]);a.builtin("FileAttachment",e.fileAttachments(e=>o.get(e))),a.variable(t()).define(["md"],R),a.variable(t("cabecalho")).define("cabecalho",["html","copyLinkButton"],N),a.define("initial mp",["urlParamConf","ampliaMenu"],L),a.variable(t("mutable mp")).define("mutable mp",["Mutable","initial mp"],(e,t)=>new e(t)),a.variable(t("mp")).define("mp",["mutable mp"],e=>e.generator),a.variable(t("listenerFiltroGlobal")).define("listenerFiltroGlobal",["mutable conf_trilhas","mutable data","mutable sel_municipios","funcoesFetch","funcoesProc"],k),a.variable(t("div_controles")).define("div_controles",["html","barra_municipios","viewof intervalo"],D),a.variable(t("vis")).define("vis",["conf_trilhas","funcoesGeradoras","gAdicionaTrilha","Sortable","mutable conf_trilhas","d3"],P),a.variable(t("maxMunicipios")).define("maxMunicipios",F),a.variable(t("viewof intervalo")).define("viewof intervalo",["urlParamConf","slider_snap","defaultConf"],B),a.variable(t("intervalo")).define("intervalo",["Generators","viewof intervalo"],(e,t)=>e.input(t)),a.variable(t("barra_municipios")).define("barra_municipios",["html","sel_municipios","remove_mun_button","maxMunicipios","menu_municipios"],$),a.variable(t("menu_municipios")).define("menu_municipios",["d3","html","agregacoes","municipios","sel_municipios","maxMunicipios","mutable sel_municipios","colors","conf_trilhas","funcoesFetch","mp","mutable data","funcoesProc","data"],U),a.variable(t("remove_mun_button")).define("remove_mun_button",["d3","sel_municipios","mutable sel_municipios","mutable data","data","agregacoes","municipios"],G),a.variable(t("remove_trilha_button")).define("remove_trilha_button",["d3","removeTrilha"],H),a.variable(t("copy_button")).define("copy_button",["d3","copyTrilha"],V),a.variable(t("funcoesGeradoras")).define("funcoesGeradoras",["gPM25","gPESO","gROBSON","gTOTAL"],j),a.variable(t("funcoesProc")).define("funcoesProc",["procPM25","procPESO","procRobson","procTOTAL"],z),a.variable(t("funcoesFetch")).define("funcoesFetch",["fetchPM25","fetchPESO","fetchRobson","fetchTOTAL"],Z),a.variable(t("style")).define("style",["html"],J),a.variable(t("corTrilha")).define("corTrilha",q),a.variable(t("corTrilhaFraco")).define("corTrilhaFraco",W),a.variable(t("mouseDownHandler")).define("mouseDownHandler",["d3","mutable sel"],X),a.variable(t("legendTooltip")).define("legendTooltip",["d3","valoresLista","corTrilhaFraco"],Q),a.variable(t("valoresLista")).define("valoresLista",["sel_municipios","data","semanas_epidemiologicas","d3","sel","unidades","agregacoes","siglas","bisector"],Y),a.variable(t("mouseDisplace")).define("mouseDisplace",K),a.variable(t("iconeContinuo")).define("iconeContinuo",["svg"],ee),a.variable(t("iconeTracejado")).define("iconeTracejado",["svg"],et),a.variable(t("iconeEspesso")).define("iconeEspesso",["svg"],ei),a.variable(t("iconeFino")).define("iconeFino",["svg"],ea),a.variable(t("gPM25")).define("gPM25",["Plot","width","height","formatTime","conf_trilhas","semanas_epidemiologicas","intervalo","maxScale","indicador","padroes","data","siglas","filterDate","janela","lineWidth","sel_municipios","bisector","sel","legendTooltip","mouseDownHandler","html","corTrilha","d3","removeTrilha","copy_button","checkMediaMovel","checkTempo","inner_slider"],en),a.variable(t("gPESO")).define("gPESO",["sel_municipios","data","gLoadingTrilha","conf_trilhas","mp","Plot","width","height","semanas_epidemiologicas","intervalo","filterDate","janela","lineWidthFiltered","lineWidth","bisector","sel","legendTooltip","mouseDownHandler","html","corTrilha","d3","removeTrilha","copy_button","checkMediaMovel","checkTempo","inner_slider","checkFiltros"],eo),a.variable(t("gROBSON")).define("gROBSON",["sel_municipios","data","gLoadingTrilha","conf_trilhas","mp","Plot","width","height","semanas_epidemiologicas","intervalo","filterDate","janela","lineWidthFiltered","lineWidth","bisector","sel","legendTooltip","mouseDownHandler","html","corTrilha","d3","removeTrilha","copy_button","checkRobson","checkMediaMovel","checkTempo","checkEscala","inner_slider","checkFiltros"],er),a.variable(t("gTOTAL")).define("gTOTAL",["sel_municipios","data","gLoadingTrilha","conf_trilhas","mp","Plot","width","height","semanas_epidemiologicas","intervalo","filterDate","janela","lineWidthFiltered","lineWidth","bisector","sel","legendTooltip","mouseDownHandler","html","corTrilha","d3","removeTrilha","copy_button","checkMediaMovel","checkTempo","checkEscala","inner_slider","checkFiltros"],el),a.variable(t("gListaValores")).define("gListaValores",["conf_trilhas","data","html","semanas_epidemiologicas","d3","sel","iconeEspesso","siglas","sel_municipios","bisector","iconeFino","unidades","agregacoes"],es),a.variable(t("gAdicionaTrilha")).define("gAdicionaTrilha",["html","d3","removeTrilha","copyTrilha","width","addTrilha"],ed),a.variable(t("gLoadingTrilha")).define("gLoadingTrilha",["html","d3","removeTrilha","copyTrilha","width"],ec),a.variable(t("copyTrilha")).define("copyTrilha",["conf_trilhas","d3","listenerFiltro","mutable conf_trilhas","data","mutable data"],eu),a.variable(t("removeTrilha")).define("removeTrilha",["mutable conf_trilhas","conf_trilhas","mutable data","data"],ep),a.variable(t("addTrilha")).define("addTrilha",["d3","conf_trilhas","mutable conf_trilhas","sel_municipios","fetchPM25","mutable data","procPM25","ampliaMenu","corTrilha","listenerFiltro","fetchPESO","procPESO","fetchRobson","procRobson","fetchTOTAL","procTOTAL"],em),a.variable(t("inner_slider")).define("inner_slider",["conf_trilhas","slider_snap","width","mutable conf_trilhas"],ef),a.variable(t("checkPoluente")).define("checkPoluente",["conf_trilhas","mutable conf_trilhas"],ev),a.variable(t("checkFiltros")).define("checkFiltros",["conf_trilhas","mutable data","ampliaMenu","mp","corTrilha","listenerFiltro","mutable sel_municipios","funcoesFetch","funcoesProc","mutable conf_trilhas"],eh),a.variable(t("checkTempo")).define("checkTempo",["conf_trilhas","intervalo","mutable conf_trilhas"],eb),a.variable(t("checkRobson")).define("checkRobson",["conf_trilhas","mutable conf_trilhas"],ex),a.variable(t("checkEscala")).define("checkEscala",["conf_trilhas","mutable conf_trilhas"],eg),a.variable(t("checkMediaMovel")).define("checkMediaMovel",["conf_trilhas","mutable conf_trilhas"],ey),a.variable(t("converteIntervalo")).define("converteIntervalo",["semanas_epidemiologicas"],eA),a.define("initial conf_principal",ew),a.variable(t("mutable conf_principal")).define("mutable conf_principal",["Mutable","initial conf_principal"],(e,t)=>new e(t)),a.variable(t("conf_principal")).define("conf_principal",["mutable conf_principal"],e=>e.generator),a.define("initial conf_trilhas",["urlParamConf","ampliaMenu","corTrilha"],eC),a.variable(t("mutable conf_trilhas")).define("mutable conf_trilhas",["Mutable","initial conf_trilhas"],(e,t)=>new e(t)),a.variable(t("conf_trilhas")).define("conf_trilhas",["mutable conf_trilhas"],e=>e.generator),a.variable(t("unidades")).define("unidades",eE),a.variable(t("lineWidth")).define("lineWidth",eO),a.variable(t("lineWidthFiltered")).define("lineWidthFiltered",e_),a.define("initial firstload",eS),a.variable(t("mutable firstload")).define("mutable firstload",["Mutable","initial firstload"],(e,t)=>new e(t)),a.variable(t("firstload")).define("firstload",["mutable firstload"],e=>e.generator),a.define("initial municipiosDefault",["urlParamConf","defaultConf"],eM),a.variable(t("mutable municipiosDefault")).define("mutable municipiosDefault",["Mutable","initial municipiosDefault"],(e,t)=>new e(t)),a.variable(t("municipiosDefault")).define("municipiosDefault",["mutable municipiosDefault"],e=>e.generator),a.variable(t("onfirstload")).define("onfirstload",["firstload","mutable municipiosDefault","mutable sel_municipios","conf_trilhas","funcoesFetch","mp","mutable data","funcoesProc","listenerFiltro","listenerFiltroGlobal","sessionStorage","getCurrentConf","viewof intervalo","mutable firstload"],eT),a.variable(t("listenerFiltro")).define("listenerFiltro",["mutable data","mutable sel_municipios","funcoesFetch","funcoesProc"],eI),a.variable(t("viewof janela")).define("viewof janela",["Inputs"],eR),a.variable(t("janela")).define("janela",["Generators","viewof janela"],(e,t)=>e.input(t)),a.variable(t("viewof indicador")).define("viewof indicador",["Inputs"],eN),a.variable(t("indicador")).define("indicador",["Generators","viewof indicador"],(e,t)=>e.input(t)),a.variable(t("colors")).define("colors",eL),a.define("initial sel_variaveis",ek),a.variable(t("mutable sel_variaveis")).define("mutable sel_variaveis",["Mutable","initial sel_variaveis"],(e,t)=>new e(t)),a.variable(t("sel_variaveis")).define("sel_variaveis",["mutable sel_variaveis"],e=>e.generator),a.define("initial sel_municipios",eD),a.variable(t("mutable sel_municipios")).define("mutable sel_municipios",["Mutable","initial sel_municipios"],(e,t)=>new e(t)),a.variable(t("sel_municipios")).define("sel_municipios",["mutable sel_municipios"],e=>e.generator),a.define("initial sel",["semanas_epidemiologicas","d3","urlParamConf","defaultConf"],eP),a.variable(t("mutable sel")).define("mutable sel",["Mutable","initial sel"],(e,t)=>new e(t)),a.variable(t("sel")).define("sel",["mutable sel"],e=>e.generator),a.variable(t("bisector")).define("bisector",["d3"],eF),a.variable(t("formatTime")).define("formatTime",["d3"],eB),a.variable(t("computaMediaMovel")).define("computaMediaMovel",["janela"],e$),a.variable(t("periodoInicio")).define("periodoInicio",["intervalo"],eU),a.variable(t("periodoFim")).define("periodoFim",["intervalo"],eG),a.variable(t("filterDate")).define("filterDate",["conf_trilhas","janela","semanas_epidemiologicas","periodoInicio","periodoFim"],eH),a.variable(t("height")).define("height",eV),a.define("initial loading",ej),a.variable(t("mutable loading")).define("mutable loading",["Mutable","initial loading"],(e,t)=>new e(t)),a.variable(t("loading")).define("loading",["mutable loading"],e=>e.generator),a.variable(t("sqlSisam")).define("sqlSisam",["mutable loading","municipios","SQLiteDatabaseClient"],ez),a.variable(t("style2")).define("style2",["html"],eZ),a.variable(t("municipios")).define("municipios",["FileAttachment"],eJ),a.variable(t("semanas_epidemiologicas")).define("semanas_epidemiologicas",["FileAttachment"],eq),a.variable(t("capitais")).define("capitais",eW),a.variable(t("siglas")).define("siglas",eX),a.define("initial data",eQ),a.variable(t("mutable data")).define("mutable data",["Mutable","initial data"],(e,t)=>new e(t)),a.variable(t("data")).define("data",["mutable data"],e=>e.generator),a.define("initial cache",eY),a.variable(t("mutable cache")).define("mutable cache",["Mutable","initial cache"],(e,t)=>new e(t)),a.variable(t("cache")).define("cache",["mutable cache"],e=>e.generator),a.variable(t("months")).define("months",eK),a.variable(t("agregacoes")).define("agregacoes",["siglas"],e0),a.variable(t("queryLocalSINASC")).define("queryLocalSINASC",["agregacoes"],e1),a.variable(t("queryLocalSISAM")).define("queryLocalSISAM",["agregacoes","siglas","municipios"],e2),a.variable(t()).define(["md"],e5),a.variable(t("objToUrlParam")).define("objToUrlParam",["lz"],e3),a.variable(t("urlParamToObj")).define("urlParamToObj",["lz"],e4),a.variable(t("getCurrentConf")).define("getCurrentConf",["mutable mp","mutable sel_municipios","intervalo","mutable conf_trilhas"],e7),a.variable(t("defaultConf")).define("defaultConf",e6),a.variable(t("urlParamConf")).define("urlParamConf",["URLSearchParams","urlParamToObj","sessionStorage","defaultConf"],e8),a.variable(t("copyToClipboard")).define("copyToClipboard",e9),a.variable(t("currentHref")).define("currentHref",te),a.variable(t("copyLinkButton")).define("copyLinkButton",["svg","currentHref","objToUrlParam","getCurrentConf","copyToClipboard"],tt),a.variable(t()).define(["md"],ti),a.variable(t("maxScale")).define("maxScale",ta),a.variable(t("volume_mol")).define("volume_mol",tn),a.variable(t("massa_mol")).define("massa_mol",to),a.variable(t("padroes")).define("padroes",tr),a.variable(t("fetchPM25")).define("fetchPM25",["indicador","sqlSisam"],tl),a.variable(t("procPM25")).define("procPM25",["semanas_epidemiologicas","indicador","massa_mol","volume_mol"],ts),a.variable(t()).define(["md"],td),a.variable(t("fetchPESO")).define("fetchPESO",["agregacoes","municipios","newDataSource"],tc),a.variable(t("procPESO")).define("procPESO",["semanas_epidemiologicas"],tu),a.variable(t("fetchRobson")).define("fetchRobson",["agregacoes","municipios","newDataSource"],tp),a.variable(t("procRobson")).define("procRobson",["procTOTALUnfiltered","semanas_epidemiologicas"],tm),a.variable(t("procTOTALUnfiltered")).define("procTOTALUnfiltered",["semanas_epidemiologicas"],tf),a.variable(t("fetchTOTAL")).define("fetchTOTAL",["agregacoes","municipios","newDataSource"],tv),a.variable(t("procTOTAL")).define("procTOTAL",["procTOTALUnfiltered","semanas_epidemiologicas"],th),a.variable(t()).define(["md"],tb),a.variable(t("Sortable")).define("Sortable",["require"],tx),a.variable(t("d3_5")).define("d3_5",["require"],tg),a.variable(t("slider_snap")).define("slider_snap",["layout","d3_5","DOM","months","semanas_epidemiologicas","mutable sel","d3"],ty),a.variable(t("layout")).define("layout",tA),a.variable(t("style_slider")).define("style_slider",["html"],tw);let r=e.module(I);return a.import("menuCaracteristicasNascimento","ampliaMenu",r),a.import("datasource","newDataSource",r),a.variable(t("lz")).define("lz",["require"],tC),a.variable(t("style_menu")).define("style_menu",["html"],tE),a.variable(t("novoMenuMun")).define("novoMenuMun",["html","agregacoes","municipios"],tO),a.variable(t("styleMenuMun")).define("styleMenuMun",["html"],t_),a.variable(t("initializeMenuMun")).define("initializeMenuMun",["novoMenuMun"],tS),a}i.d(t,{Z:function(){return tM}})}}]);