"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[360],{8659:function(e,t,i){e.exports=i.p+"static/media/186949b230e46bbd80611c8b1224e2003c90fd71528ff034cabe25dc74445f782670632623e35cfdc778c27fcc6fce67fe7fc4e12ef7168cbf594a25934412d3.fe6d926d.csv"},4084:function(e,t,i){e.exports=i.p+"static/media/f2201770123f4b364781aee7ac3512db444637a3ad42ef096c62d05e6637e8d48b4875ec59b514f9f028ae6c85b557a5d74de4b1e2d1c18d62c5114c6c9c27fa.213d22d6.csv"},7360:function(e,t,i){function a(e){return e`# Amplia Saude - Fonte de Dados e Menu - AGO2022`}function n(e){return e`## Menu Amplia`}function o(e){return function(t,i){let a=`<svg width="19" height="10" viewBox="0 0 19 10" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</svg>`,o=0,l=Symbol(),r=Symbol(),s=Symbol();function d(a,n,d,u){n=n||"";let p=document.createElement("div"),m={},f={},v={};Object.defineProperty(m,"expression",{get(){let e={};for(let t in m){let i=m[t];"expression"!=t&&(e[i[0]]=i[1])}return e}}),Object.defineProperty(m,"urlids",{get(){let e=[];for(let t in v)e.push(v[t]);return e.join("")}});let h=document.createElement("div"),x=document.createElement("div"),b=document.createElement("div"),g=document.createElement("div"),y=document.createElement("div"),A=document.createElement("div");h.classList.add("menuAbas"),x.classList.add("abas"),g.classList.add("legenda"),b.classList.add("menuCompacto"),y.classList.add("background-1"),A.classList.add("background-2"),h.append(x),h.append(b),h.append(y),h.append(A),b.append(g),h.setAttribute("style",`--corFundoMenu: ${d};`),u&&h.classList.add("principal"),t.forEach((t,a)=>{!function(t,a,d){let c="m"+ ++o,u=document.createElement("div"),h=document.createElement("div"),x=document.createElement("div"),b=document.createElement("div"),g=document.createElement("div"),y=document.createElement("div"),A=document.createElement("div"),E=document.createElement("div"),C=d+2;m[a.varName]="",f[a.varName]="",v[a.varName]="";let w=[];function _(){u[r](),p.dispatchEvent(new e("input"))}u[r]=function(){let e=w.filter(e=>e.checked).map(e=>e.value),t=w.filter(e=>e.checked).map(e=>e[s].expression),i=w.filter(e=>e.checked).map(e=>e[s].urlid);m[a.varName]=[a.attrIndex,t],v[a.varName]=i.join(""),e.length?h.classList.add("selecionado"):h.classList.remove("selecionado");let n=e.join(" ou ");g.innerHTML=n,g.setAttribute("title",n),f[a.varName]=n},u.classList.add("itemMenuCompacto"),u.classList.add(a.varName),h.classList.add("titulo"),h.innerHTML=a.title,b.classList.add("valoresSelecionados"),g.classList.add("textoValoresSelecionados"),y.classList.add("icone"),y.innerHTML="expand_more",u.append(h),x.append(b),u.append(x),b.append(y),b.append(g),A.classList.add("submenu"),A.style["grid-column"]=C+"/"+(C+1),E.classList.add("itens"),E.classList.add("i"+d),E.classList.add("ABA"+i),A.append(E),u[l]=A,u.style["grid-column-start"]=C,u.addEventListener("click",e=>{if(u.classList.contains("aberto"))u.classList.remove("aberto"),A.classList.remove("aberto");else{let t=u.parentNode.querySelector(".aberto");t&&(t.classList.remove("aberto"),t[l].classList.remove("aberto")),u.classList.add("aberto"),A.classList.add("aberto")}});let O=null;a.itens.forEach((e,t)=>{let i=document.createElement("div"),o=document.createElement("label"),l=document.createElement("input");o.innerHTML=e.name,o.setAttribute("for",c+t),l.setAttribute("type",a.input),l.setAttribute("value",e.name),n.indexOf(e.urlid)>=0&&l.setAttribute("checked","checked"),l.setAttribute("id",c+t),l.setAttribute("name","radio"===a.input?c:c+t),l[s]=e,i.classList.add("item"),i.append(l),i.append(o),E.append(i),w.push(l),l.addEventListener("input",e=>{e.stopPropagation(),_()}),"radio"==a.input&&l.addEventListener("click",e=>{if(e.target===O){e.target.checked=!1,O=null,_();return}O=e.target})}),t.append(u),t.append(A),u[r]()}(b,t,a)});let E=p.attachShadow({mode:"open"});return E.append(function(){let e=document.createElement("style");return e.textContent=`                  
          div.menuAbas {
...
`}function L(e,t){return e?new t.principal(e.principalUrlids):new t.principal}function N(e,t,i,a,n){return o=>{e.value.filter(e=>"PM25"!=e.variavel).forEach(e=>{t.value=t.value.filter(t=>t.idx!=e.i||t.filtrado),i.value.forEach(i=>{Promise.all([a[e.variavel](i.nome,o.target.value.expression)]).then(a=>{t.value=t.value.filter(t=>t.idx!=e.i||t.filtrado||t.municipio!=i.nome),t.value=t.value.concat({idx:e.i,municipio:i.nome,variavel:e.variavel,dados:n[e.variavel](a[0])})})})})}}function k(e,t,i){return e`
<div style="display:flex; width:100%; align-items:center; justify-content:space-between;">
<div>${t}</div><div>${i}</div>
</div>
`}function R(e,t,i,a,n,o,l){let r=document.createElement("div");for(let s=0;s<e.length;s++)r.append(t[e[s].variavel](e[s].i));return r.append(i()),a.create(r,{animation:150,handle:".drag",filter:".undraggable",onUpdate(t){let i=e[t.oldIndex];e.splice(t.oldIndex,1),e.splice(t.newIndex,0,i),n.value=e}}),document.removeEventListener("scroll",o),document.addEventListener("scroll",o),l.select(r).selectAll("g[aria-label=x-axis] g.tick text").each(function(){let e=l.select(this),t=e.text();/[0-9]{4}/.test(t)&&e.style("font-size","14px").style("font-weight","700")}),r}function F(){return function(){document.querySelectorAll(".tooltip").forEach(e=>setTimeout(e.updatePosition()))}}function G(){return 4}function U(e,t,i){return e?t(104,468,e.intervalo[0],e.intervalo[1]):t(104,468,i.intervalo[0],i.intervalo[1])}function $(e,t,i,a,n){return e`<!-- <label class="label-locais">LOCAIS </label> -->
...
<div class="trilha" i=${T}>
  <div class="cabecalho-trilha">
    <label class="label-titulo-trilha">POLUENTE</label>

    <label class="label-cabecalho-trilha">MÉDIA MÓVEL</label> ${A.create("input").attr("type","checkbox").property("checked",n.find(e=>e.i==T).mostra_media_movel).on("change",O).node()}
    <label class="label-cabecalho-trilha">MODIFICAR PERÍODO</label> ${A.create("input").attr("type","checkbox").property("checked",n.find(e=>e.i==T).alterar_tempo).on("change",M).node()}
  </div>
...
</div>`}}function el(e,t,i,a,n,o,l,r,s,d,c,u,p,m,f,v,h,x,b,g,y,A,E,C,w,_,O,M){return I=>{if(!e.map(e=>e.nome).every(e=>t.filter(e=>e.idx==I).map(e=>e.municipio).includes(e))||a.find(e=>e.i==I).filtros.value.expression&&a.find(e=>e.i==I).show_filtros&&t.filter(e=>e.idx==I).every(e=>void 0===e.filtrado)||n.value.expression&&t.filter(e=>e.idx==I).every(e=>void 0!==e.filtrado))return i();let T=o.plot({marginTop:5,marginRight:0,width:l-65,height:r,x:{grid:!0,label:null,domain:a.find(e=>e.i==I).alterar_tempo?a.find(e=>e.i==I).alterar_tempo.map(e=>s[e].inicio):d.map(e=>s[e].inicio)},y:{grid:!0,label:null},marks:[a.find(e=>e.i==I).mostra_media_movel?t.filter(e=>e.idx==I).map((t,i)=>o.line(t.dados.filter(e=>c(e,I)),o.windowY({strict:!0,k:u,anchor:"middle",x:"x",y:"valor",strokeWidth:t.filtrado?p:m,stroke:e.find(e=>e.nome==t.municipio).cor,strokeDasharray:t.filtrado?"3":"1"}))):t.filter(e=>e.idx==I).map((t,i)=>o.line(t.dados.filter(e=>c(e,I)),{sort:"x",x:"x",y:"valor",curve:"monotone-x",strokeWidth:t.filtrado?p:m,stroke:e.find(e=>e.nome==t.municipio).cor,strokeDasharray:t.filtrado?"3":"1"})),o.ruleX([t.filter(e=>e.idx==I)[0].dados[f.center(t.filter(e=>e.idx==I)[0].dados,v)]],{x:"x",strokeDasharray:"5"}),a.find(e=>e.i==I).mostra_media_movel?null:t.filter(e=>e.idx==I).map((t,i)=>o.dot([t.dados[f.center(t.dados,v)]],{x:"x",y:"valor",fill:e.find(e=>e.nome==t.municipio).cor}))]});return h(T,"PESO",I),T.onmousedown=e=>{x.value=Math.min(Math.max(T.scale("x").invert(e.offsetX),T.scale("x").domain[0]),T.scale("x").domain[1])},b.select(T).call(b.drag().on("drag",e=>x.value=Math.min(Math.max(T.scale("x").invert(e.x-g(e.x)),T.scale("x").domain[0]),T.scale("x").domain[1]))),y`
...
<div class="trilha" i=${I}>
  <div class="cabecalho-trilha">
    <label class="label-titulo-trilha">PESO AO NASCER</label>
    <label class="label-cabecalho-trilha">MÉDIA MÓVEL</label> ${b.create("input").attr("type","checkbox").property("checked",a.find(e=>e.i==I).mostra_media_movel).on("change",w).node()}
    <label class="label-cabecalho-trilha">MODIFICAR PERÍODO</label> ${b.create("input").attr("type","checkbox").property("checked",a.find(e=>e.i==I).alterar_tempo).on("change",_).node()}
  </div>
<div class="conteudo-trilha">
...
${b.create("input").attr("type","checkbox").property("checked",a.find(e=>e.i==I).show_filtros).on("change",M).node()}
...
</div>`}}function er(e,t,i,a,n,o,l,r,s,d,c,u,p,m,f,v,h,x,b,g,y,A,E,C,w,_,O,M,I,T){return S=>{if(!e.map(e=>e.nome).every(e=>t.filter(e=>e.idx==S).map(e=>e.municipio).includes(e))||a.find(e=>e.i==S).filtros.value.expression&&a.find(e=>e.i==S).show_filtros&&t.filter(e=>e.idx==S).every(e=>void 0===e.filtrado)||n.value.expression&&t.filter(e=>e.idx==S).every(e=>void 0!==e.filtrado))return i();let P=a.find(e=>e.i==S).escala,D=a.find(e=>e.i==S).tamanho,L=o.plot({marginTop:5,marginRight:0,width:l-65,height:r,x:{grid:!0,label:null,domain:a.find(e=>e.i==S).alterar_tempo?a.find(e=>e.i==S).alterar_tempo.map(e=>s[e].inicio):d.map(e=>s[e].inicio)},y:{grid:!0,label:null},marks:[a.find(e=>e.i==S).mostra_media_movel?t.filter(e=>e.idx==S).map((t,i)=>o.line(t.dados.filter(e=>c(e,S)),o.windowY({strict:!0,k:u,anchor:"middle",x:"x",y:e=>e[P][D],strokeWidth:t.filtrado?p:m,stroke:e.find(e=>e.nome==t.municipio).cor,strokeDasharray:t.filtrado?"3":"1"}))):t.filter(e=>e.idx==S).map((t,i)=>o.line(t.dados.filter(e=>c(e,S)),{sort:"x",x:"x",y:e=>e[P][D],curve:"monotone-x",strokeWidth:t.filtrado?p:m,stroke:e.find(e=>e.nome==t.municipio).cor,strokeDasharray:t.filtrado?"3":"1"})),o.ruleX([t.filter(e=>e.idx==S)[0].dados[f.center(t.filter(e=>e.idx==S)[0].dados,v)]],{x:"x",strokeDasharray:"5"}),a.find(e=>e.i==S).mostra_media_movel?null:t.filter(e=>e.idx==S).map((t,i)=>o.dot([t.dados[f.center(t.dados,v)]],{x:"x",y:e=>e[P][D],fill:e.find(e=>e.nome==t.municipio).cor}))]});h(L,"PIG",S,P,D),L.onmousedown=e=>{x.value=Math.min(Math.max(L.scale("x").invert(e.offsetX),L.scale("x").domain[0]),L.scale("x").domain[1])},b.select(L).call(b.drag().on("drag",e=>x.value=Math.min(Math.max(L.scale("x").invert(e.x-g(e.x)),L.scale("x").domain[0]),L.scale("x").domain[1])));let N;return y`
...
<div class="trilha" i=${S}>
  <div class="cabecalho-trilha">
    <label class="label-titulo-trilha">ADEQUAÇÃO À IDADE GESTACIONAL</label>

    ${(N=b.create("select").attr("class","menuIG")).style("font-family","Roboto Condensed"),N.append("option").attr("name","PEQUENO").text("PEQUENO").property("selected","PEQUENO"==a.find(e=>e.i==S).tamanho),N.append("option").attr("name","ADEQUADO").text("ADEQUADO").property("selected","ADEQUADO"==a.find(e=>e.i==S).tamanho),N.append("option").attr("name","GRANDE").text("GRANDE").property("selected","GRANDE"==a.find(e=>e.i==S).tamanho),N.on("change",w),N.node()}

    <label class="label-cabecalho-trilha">MÉDIA MÓVEL</label> ${b.create("input").attr("type","checkbox").property("checked",a.find(e=>e.i==S).mostra_media_movel).on("change",_).node()}

    <label class="label-cabecalho-trilha">MODIFICAR PERÍODO</label> ${b.create("input").attr("type","checkbox").property("checked",a.find(e=>e.i==S).alterar_tempo).on("change",O).node()}
    
    <label class="label-cabecalho-trilha" style="margin: 0px 0px 0px 30px;">ESCALA</label>
    <label class="label-cabecalho-trilha"> ABSOLUTO</label>
    ${b.create("input").attr("type","radio").attr("name","escala_"+S).property("checked","absoluto"==a.find(e=>e.i==S).escala).attr("value","absoluto").on("change",M).node()}
    <label class="label-cabecalho-trilha"> PERCENTUAL</label>
    ${b.create("input").attr("type","radio").attr("name","escala_"+S).property("checked","percentual"==a.find(e=>e.i==S).escala).attr("value","percentual").on("change",M).node()}
    <label class="label-cabecalho-trilha"> TAXA POR 1000</label>
    ${b.create("input").attr("type","radio").attr("name","escala_"+S).property("checked","taxa"==a.find(e=>e.i==S).escala).attr("value","taxa").on("change",M).node()}
  </div>
...
<div class="rodape-trilha">
<div class="botao-comparacao">
${b.create("input").attr("type","checkbox").property("checked",a.find(e=>e.i==S).show_filtros).on("change",T).node()}
<label>COMPARAÇÃO</label>
</div>
...
<div class="trilha" i=${T}>
  <div class="cabecalho-trilha">
    <label class="label-titulo-trilha">NASCIMENTOS TOTAIS</label>
    <label class="label-cabecalho-trilha">MÉDIA MÓVEL</label> ${b.create("input").attr("type","checkbox").property("checked",a.find(e=>e.i==T).mostra_media_movel).on("change",w).node()}
    <label class="label-cabecalho-trilha">MODIFICAR PERÍODO</label> ${b.create("input").attr("type","checkbox").property("checked",a.find(e=>e.i==T).alterar_tempo).on("change",_).node()}
    <label class="label-cabecalho-trilha" style="margin: 0px 0px 0px 30px;">ESCALA</label>
    <label class="label-cabecalho-trilha"> ABSOLUTO</label>
    ${b.create("input").attr("type","radio").attr("name","escala_"+T).property("checked","absoluto"==a.find(e=>e.i==T).escala).attr("value","absoluto").on("change",O).node()}
    <label class="label-cabecalho-trilha"> PERCENTUAL</label>
    ${b.create("input").attr("type","radio").attr("name","escala_"+T).property("checked","percentual"==a.find(e=>e.i==T).escala).attr("value","percentual").on("change",O).node()}
  </div>
<div class="conteudo-trilha">
...
<div class="rodape-trilha">
<div class="botao-comparacao">
${b.create("input").attr("type","checkbox").property("checked",a.find(e=>e.i==T).show_filtros).on("change",I).node()}
<label>COMPARAÇÃO</label>
</div>
...
${("PIG"!=h?t.filter(e=>!e.filtrado&&e.idx==m&&(!Object.values(r).includes(e.municipio)||"PM25"!=h)).sort((e,t)=>s.findIndex(e=>e.nome==t.municipio)-s.findIndex(t=>t.nome==e.municipio)):t.filter(e=>!e.filtrado&&e.idx==m).sort((e,t)=>s.findIndex(e=>e.nome==t.municipio)-s.findIndex(t=>t.nome==e.municipio))).map(e=>"<span class='valor' style='color:"+s.find(t=>t.nome==e.municipio).cor+";'>"+("PIG"!=h?e.dados[d.center(e.dados,o)][f].toFixed("percentual"==f||"taxa"==f?3:0):e.dados[d.center(e.dados,o)][f][v].toLocaleString("pt-BR",{maximumFractionDigits:"percentual"==f?3:"taxa"==f?2:0}))+"</span>")}
</div>
...
${("PIG"!=h?t.filter(e=>e.idx==m&&(!Object.values(r).includes(e.municipio)||"PM25"!=h)).sort((e,t)=>t.dados[d.center(t.dados,o)][f]-e.dados[d.center(e.dados,o)][f]):t.filter(e=>e.idx==m).sort((e,t)=>t.dados[d.center(t.dados,o)][f][v]-e.dados[d.center(e.dados,o)][f][v])).map(e=>"<span class='valor' style='color:"+s.find(t=>t.nome==e.municipio).cor+";'>"+("PIG"!=h?e.dados[d.center(e.dados,o)][f].toFixed("percentual"==f||"taxa"==f?3:0):e.dados[d.center(e.dados,o)][f][v].toLocaleString("pt-BR",{maximumFractionDigits:"percentual"==f?3:"taxa"==f?2:0}))+" "+u[h][f]+"</span>")}
</div>
<div>
<center>
...
</div>`}function ep(e,t,i,a,n,o){return l=>{let r=e.findIndex(e=>e.i==l.target.parentNode.parentNode.getElementsByClassName("trilha")[0].getAttribute("i")),s={...e[r]},d=t.max(e.map(e=>e.i))+1;s.i=d,"PM25"!=s.variavel&&(s.filtros=s.filtros.cloneMenu(),s.filtros.addEventListener("input",e=>i(e,s))),e.splice(r+1,0,s),a.value=e;let c=JSON.parse(JSON.stringify(n.filter(e=>e.idx==l.target.parentNode.parentNode.getElementsByClassName("trilha")[0].getAttribute("i"))));c.forEach((e,t,i)=>{i[t].idx=d,i[t].dados.forEach((e,t,i)=>i[t].x=new Date(i[t].x))}),o.value=n.concat(c)}}function em(e,t,i,a){return n=>{e.value=t.filter(e=>e.i!=n.target.parentNode.parentNode.getElementsByClassName("trilha")[0].getAttribute("i")),i.value=a.filter(e=>e.idx!=n.target.parentNode.parentNode.getElementsByClassName("trilha")[0].getAttribute("i"))}}function ef(e,t,i,a,n,o,l,r,s,d,c,u,p,m,f,v){return h=>{let x=e.max(t.map(e=>e.i))||0,b=null;switch(h.target.value){case"POLUENTE":b={i:x+1,mostra_media_movel:!0,variavel:"PM25",alterar_tempo:null,poluente:"PM25"},i.value=t.concat(b),a.forEach(e=>Promise.all([n(e.nome)]).then(t=>{o.value=o.value.concat([{idx:x+1,municipio:e.nome,variavel:"PM25",dados:l(t[0])}])}));break;case"PESO AO NASCER":(b={i:x+1,mostra_media_movel:!1,variavel:"PESO",alterar_tempo:null,filtros:new r.local(null,null,s.PESO),show_filtros:!1}).filtros.addEventListener("input",e=>d(e,b)),i.value=t.concat(b),a.forEach(e=>Promise.all([c(e.nome,b.filtros.expression)]).then(t=>{o.value=o.value.concat([{idx:x+1,municipio:e.nome,variavel:"PESO",dados:u(t[0])}])}));break;case"ADEQUA\xc7\xc3O \xc0 IDADE GESTACIONAL":(b={i:x+1,mostra_media_movel:!1,escala:"taxa",tamanho:"PEQUENO",variavel:"PIG",alterar_tempo:null,filtros:new r.local(null,null,s.PIG),show_filtros:!1}).filtros.addEventListener("input",e=>d(e,b)),i.value=t.concat(b),a.forEach(e=>Promise.all([p(e.nome,b.filtros.expression)]).then(t=>{o.value=o.value.concat([{idx:x+1,municipio:e.nome,variavel:"PIG",dados:m(t[0])}])}));break;case"NASCIMENTOS TOTAIS":(b={i:x+1,mostra_media_movel:!1,variavel:"TOTAL",alterar_tempo:null,filtros:new r.local(null,null,s.TOTAL),show_filtros:!1,escala:"absoluto"}).filtros.addEventListener("input",e=>d(e,b)),i.value=t.concat(b),a.forEach(e=>Promise.all([f(e.nome,b.filtros.expression)]).then(t=>{o.value=o.value.concat([{idx:x+1,municipio:e.nome,variavel:"TOTAL",dados:v(t[0])}])}))}}}function ev(e,t,i,a){return n=>{if(!e.find(e=>e.i==n).alterar_tempo)return"";let o=t(104,468,e.find(e=>e.i==n).alterar_tempo[0],e.find(e=>e.i==n).alterar_tempo[1],i-90,40);return o.addEventListener("input",t=>{let i=e;i.find(e=>e.i==n).alterar_tempo=o.value,a.value=i}),o}}function eh(e,t){return i=>{e.find(e=>e.i==i.target.parentElement.parentElement.getAttribute("i")).poluente=i.target.value,t.value=e}}function ex(e,t,i,a,n,o,l,r,s,d){return c=>{let u=c.target.parentElement.parentElement.parentElement.getAttribute("i");if(e.find(e=>e.i==u).show_filtros=c.target.checked,c.target.checked){let p=e.find(e=>e.i==u);p.filtros=new i.local(null,a.value.urlids,n[p.variavel]),p.filtros.addEventListener("input",e=>o(e,p)),t.value=t.value.filter(e=>e.idx!=u||!e.filtrado),l.value.forEach(i=>{Promise.all([r[e.find(e=>e.i==u).variavel](i.nome,e.find(e=>e.i==u).filtros.value.expression)]).then(a=>{t.value=t.value.concat({idx:u,municipio:i.nome,variavel:e.find(e=>e.i==u).variavel,filtrado:!0,dados:s[e.find(e=>e.i==u).variavel](a[0])})})})}else t.value=t.value.filter(e=>e.idx!=u||!e.filtrado);d.value=e}}function eb(e,t,i){return a=>{a.target.checked?e.find(e=>e.i==a.target.parentElement.parentElement.getAttribute("i")).alterar_tempo=t:e.find(e=>e.i==a.target.parentElement.parentElement.getAttribute("i")).alterar_tempo=null,i.value=e}}function eg(e,t){return i=>{e.find(e=>e.i==i.target.parentElement.parentElement.getAttribute("i")).tamanho=i.target.value,t.value=e}}function ey(e,t){return i=>{e.find(e=>e.i==i.target.parentElement.parentElement.getAttribute("i")).escala=i.target.value,t.value=e}}function eA(e,t){return i=>{e.find(e=>e.i==i.target.parentElement.parentElement.getAttribute("i")).mostra_media_movel=i.target.checked,t.value=e}}function eE(e){return t=>{let i=[0,0];return i[0]=e[t[0]].inicio,i[1]=e[t[1]].termino,i}}function eC(){return""}function ew(e,t,i){return e?e.trilhas.map(e=>(e.filtros=new t.local(null,e.filtrosUrlids),e)):[{i:0,mostra_media_movel:!0,variavel:"PM25",alterar_tempo:null,poluente:"PM25"},{i:1,mostra_media_movel:!1,variavel:"PESO",alterar_tempo:null,filtros:new t.local(null,null,i.PESO),show_filtros:!1},{i:2,mostra_media_movel:!1,escala:"taxa",tamanho:"PEQUENO",variavel:"PIG",alterar_tempo:null,filtros:new t.local(null,null,i.PIG),show_filtros:!1}]}function e_(){return{PM25:{valor:"\xb5g/m\xb3"},PESO:{valor:"g"},PIG:{absoluto:"nascimentos",percentual:"%",taxa:"nasc./1000NV"},TOTAL:{absoluto:"nascimentos",percentual:"%"}}}function eO(){return 2.5}function eM(){return 2}function eI(){return!0}function eT(e,t){return e?e.municipios:t.municipios}function eS(e,t,i,a,n,o,l,r,s,d,c,u,p,m){if(e){for(let f of t.value)i.value=i.value.concat([f]),f=f.nome,a.forEach(e=>{Promise.all([n[e.variavel](f,o.value.expression)]).then(t=>{l.value=l.value.concat({idx:e.i,municipio:f,variavel:e.variavel,dados:r[e.variavel](t[0])})}),e.show_filtros&&Promise.all([n[e.variavel](f,e.filtros.value.expression)]).then(t=>{l.value=l.value.concat({idx:e.i,municipio:f,variavel:e.variavel,filtrado:!0,dados:r[e.variavel](t[0])})})}),a.slice(1).forEach(e=>e.filtros.addEventListener("input",t=>s(t,e)));o.addEventListener("input",e=>d(e)),o.addEventListener("aba",e=>{c.setItem("conf",JSON.stringify(u())),c.setItem("municipios",JSON.stringify(i.value)),c.setItem("intervalo",JSON.stringify(p.value))}),m.value=!1}}function eP(e,t,i,a){return(n,o)=>{e.value=e.value.filter(e=>e.idx!=o.i||!e.filtrado),t.value.forEach(t=>{Promise.all([i[o.variavel](t.nome,o.filtros.value.expression)]).then(i=>{e.value=e.value.concat({idx:o.i,municipio:t.nome,variavel:o.variavel,filtrado:!0,dados:a[o.variavel](i[0])})})})}}function eD(e){return e.range([3,53],{label:"Janela em semanas",value:13,step:2})}function eL(e){return e.select(["co_ppb","no2_ppb","o3_ppb","pm25_ugm3","so2_ugm3"],{label:"Indicador",value:"pm25_ugm3"})}function eN(){return["#2F87F5","#D8C56C","#DC5988","#6CC28D","#67AEC2","#ABA6F8","#D8C56C","#2DE8BD","#2F87F5","#94E8F9"]}function ek(){return[]}function eR(){return[]}function eF(e,t,i,a){return e[Math.ceil(t.interpolate(...i?i.intervalo:a.intervalo)(.5))].inicio}function eG(e){return e.bisector(e=>e.x)}function eU(e){return e.timeFormatDefaultLocale({decimal:",",thousands:".",grouping:[3],currency:["$",""],dateTime:"%a %b %e %X %Y",date:"%d/%m/%Y",time:"%H:%M:%S",periods:["AM","PM"],days:["Domingo","Segunda-feira","Ter\xe7a-feira","Quarta-feira","Quinta-feira","Sexta-feira","S\xe1bado"],shortDays:["Dom","Seg","Ter","Qua","Qui","Sex","Sab"],months:["Janeiro","Fevereiro","Mar\xe7o","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"],shortMonths:["Jan","Fev","Mar","Abr","Mai","Jun","Jul","Ago","Set","Out","Nov","Dez"]})}function e$(e){return function(t){let i=[];return t.forEach((a,n)=>{if(n<~~(e/2)||n>t.length-~~(e/2)-1)return;let o=0;for(let l=-~~(e/2);l<=~~(e/2);l++)o+=t[n-l].TOTAL;i.push({x:a.x,TOTAL:o/e})}),i}}function eB(e){return e[0]}function eV(e){return e[1]}function eH(e,t,i,a,n){return(o,l)=>{let r=e.find(e=>e.i==l).alterar_tempo,s=e.find(e=>e.i==l).mostra_media_movel?(t-1)/2:0;return r?o.x.getTime()>=i[r[0]-s].inicio.getTime()&&o.x.getTime()<=i[r[1]+s].termino.getTime():o.x.getTime()>=i[a-s].inicio.getTime()&&o.x.getTime()<=i[n+s].termino.getTime()}}function ej(){return 200}function ez(){return!0}function eQ(e,t,i){return function(a,n){e.value=!0;let o=t.find(e=>e.municipio==a).codigo_sdv,l=`https://storage.googleapis.com/amplia/municipios-v2/${o.substring(0,2)}/mun${o}.db`,r=i.open(l).then(e=>e.query(n));return e.value=!1,r}}function eZ(e,t,i){return function(a,n){if(2==a.length)return;e.value=!0;let o=t.find(e=>e.municipio==a).codigo_sdv,l=`https://storage.googleapis.com/amplia/sisam/${o.substring(0,2)}/mun${o}.db`,r=i.open(l).then(e=>e.query(n));return e.value=!1,r}}function eq(e){return e`<style>
  @import url('https://fonts.googleapis.com/css2?family=Fira+Sans+Condensed:wght@400;700&display=swap');
  text{
    font-family:"Fira Sans Condensed"
  }
</style>`}function eJ(e){return e("municipios2.csv").csv()}function eW(e){return e("semanas_epidemiologicas_estendido.csv").csv().then(e=>e.map(e=>(e.inicio=new Date(Date.UTC(+e.inicio.substr(0,4),+e.inicio.substr(5,2)-1,+e.inicio.substr(8,2))),e.termino=new Date(Date.UTC(+e.termino.substr(0,4),+e.termino.substr(5,2)-1,+e.termino.substr(8,2))),e)).filter(e=>e.ano>=2010))}function eX(){return{ACRE:"RIO BRANCO",ALAGOAS:"MACEI\xd3",AMAPÁ:"MACAP\xc1",AMAZONAS:"MANAUS",BAHIA:"SALVADOR",CEARÁ:"FORTALEZA","DISTRITO FEDERAL":"BRAS\xcdLIA","ESP\xcdRITO SANTO":"VIT\xd3RIA",GOIÁS:"GOI\xc2NIA",MARANHÃO:"S\xc3O LU\xcdS","MATO GROSSO":"CUIAB\xc1","MATO GROSSO DO SUL":"CAMPO GRANDE","MINAS GERAIS":"BELO HORIZONTE",PARÁ:"BEL\xc9M",PARAÍBA:"JO\xc3O PESSOA",PARANÁ:"CURITIBA",PERNAMBUCO:"RECIFE",PIAUÍ:"TERESINA","RIO DE JANEIRO":"RIO DE JANEIRO","RIO GRANDE DO NORTE":"NATAL","RIO GRANDE DO SUL":"PORTO ALEGRE",RONDÔNIA:"PORTO VELHO",RORAIMA:"BOA VISTA","SANTA CATARINA":"FLORIAN\xd3POLIS","S\xc3O PAULO":"S\xc3O PAULO",SERGIPE:"ARACAJU",TOCANTINS:"PALMAS"}}function eY(){return{ACRE:"AC",ALAGOAS:"AL",AMAPÁ:"AP",AMAZONAS:"AM",BAHIA:"BA",CEARÁ:"CE","DISTRITO FEDERAL":"DF","ESP\xcdRITO SANTO":"ES",GOIÁS:"GO",MARANHÃO:"MA","MATO GROSSO":"MT","MATO GROSSO DO SUL":"MS","MINAS GERAIS":"MG",PARÁ:"PA",PARAÍBA:"PB",PARANÁ:"PR",PERNAMBUCO:"PE",PIAUÍ:"PI","RIO DE JANEIRO":"RJ","RIO GRANDE DO NORTE":"RN","RIO GRANDE DO SUL":"RS",RONDÔNIA:"RO",RORAIMA:"RR","SANTA CATARINA":"SC","S\xc3O PAULO":"SP",SERGIPE:"SE",TOCANTINS:"TO"}}function eK(){return[]}function e0(){return[]}function e1(){return["JAN","FEV","MAR","ABR","MAI","JUN","JUL","AGO","SET","OUT","NOV","DEZ"]}function e2(e){return Object.values(e).sort(Intl.Collator().compare)}function e5(e){return t=>"BRASIL"==t?"":e.includes(t)?"AND res_SIGLA_UF='"+t+"'":"AND res_MUNNOMEX='"+t.normalize("NFD").replace(/\p{Diacritic}/gu,"")+"'"}function e3(e,t,i){return a=>"BRASIL"==a?"":e.includes(a)?"mun_uf_nome='"+Object.entries(t).find(e=>e[1]==a)[0]+"'":"mun_geocodsdv="+i.find(e=>e.municipio==a).codigo_sdv}function e4(e){return e`## URL stuff`}function e7(e){return function(t){return e.compressToEncodedURIComponent(JSON.stringify(t))}}function e6(e){return function(t){return JSON.parse(e.decompressFromEncodedURIComponent(t))}}function e8(e,t,i,a){return()=>({principalUrlids:e.value.value.urlids,municipios:t.value,intervalo:i,trilhas:a.value.map(e=>{let t={};return Object.assign(t,e),t.filtros&&(t.filtrosUrlids=t.filtros.value.urlids,delete t.filtros),t})})}function e9(){return{principalUrlids:"",municipios:[{nome:"RIO DE JANEIRO",cor:"#2F87F5"}],intervalo:[262,366],trilhas:[{i:0,mostra_media_movel:!0,variavel:"PM25",alterar_tempo:null,poluente:"PM25"},{i:1,mostra_media_movel:!1,variavel:"PESO",alterar_tempo:null,show_filtros:!1,filtrosUrlids:""},{i:2,mostra_media_movel:!1,escala:"taxa",tamanho:"PEQUENO",variavel:"PIG",alterar_tempo:null,show_filtros:!1,filtrosUrlids:""}]}}function te(e,t,i,a){let n=new e(window.location.search).get("conf");if(n)return t(n);if(n=i.getItem("conf")){let o=JSON.parse(n),l=i.getItem("municipios");l&&(o.municipios=JSON.parse(l));let r=i.getItem("intervalo");return r&&(o.intervalo=JSON.parse(r)),o}if(n=i.getItem("municipios")){let s=a;return s.municipios=JSON.parse(n),n=i.getItem("intervalo"),s.intervalo=JSON.parse(n),s}}function tt(){return function(e){var t=document.body.appendChild(document.createElement("textarea"));t.style.position="absolute",t.style.left="-9999px",t.setAttribute("readonly",""),t.value=e,t.select();try{return document.execCommand("copy")}catch(i){return!1}finally{t.parentNode.removeChild(t)}}}function ti(){return"https://ampliasaude.github.io/trilhas5.html"}function ta(e,t,i,a,n){return()=>{let o=e`<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M6.045 10C6.045 11.026 6.8095 11.86 7.75 11.86H9.95V13H7.75C6.232 13 5 11.656 5 10C5 8.344 6.232 7 7.75 7H9.95V8.14H7.75C6.8095 8.14 6.045 8.974 6.045 10ZM8.3 9.4H12.7V10.6H8.3V9.4ZM13.25 13H11.05V11.86H13.25C14.1905 11.86 14.955 11.026 14.955 10C14.955 8.974 14.1905 8.14 13.25 8.14H11.05V7H13.25C14.768 7 16 8.344 16 10C16 11.656 14.768 13 13.25 13Z" fill="white"/>
      ...
      group by
        1,2,3
 `)}function tc(e,t,i,a){return n=>{n.forEach(n=>{let o=n,l=new Date(Date.UTC(o.ano,o.mes-1,o.dia));for(let r of e)if(l>=new Date(r.inicio)&&l<=new Date(r.termino)){o.semana=+r.semana,o.x=r.inicio;break}switch(1==o.mes&&53==o.semana&&(o.ano-=1,o.mes=12),t){case"no2_ppb":case"o3_ppb":let s=i[t]/a(o.temperatura);o.valor*=s;case"co_ppb":o.valor/=1e3}});let o=[];for(let l of n){let r=o.find(e=>e.x==l.x);r?(r.valor+=l.valor,r.temperatura_c_media+=l.temperatura_c_media,r.cont+=1):o.push({ano:l.ano,semana:l.semana,x:l.x,valor:l.valor||0,temperatura_c_media:l.temperatura_c_media,cont:1})}return o.map(e=>(e.valor/=e.cont,e.temperatura_c_media/=e.cont,delete e.cont,e)).filter(e=>e.semana)}}function tu(e){return e`## Fecundação`}function tp(e,t,i){return async(a,n)=>{let o;return await i.fetchPeso(e.includes(a)?Math.floor(t.find(e=>e.sigla==a).codigo_sdv/1e4):t.find(e=>e.municipio==a).codigo_sdv,n)}}function tm(e){return t=>{t.forEach(t=>{let i=t;for(let a of(i.data=new Date(i.data),e))if(i.data>=new Date(a.inicio)&&i.data<=new Date(a.termino)){i.x=a.inicio;break}});let i=[];for(let a of t){let n=i.find(e=>e.x.getTime()==a.x.getTime());n?(n.valor+=a.valor*a.total,n.total+=a.total):i.push({x:a.x,valor:a.valor*a.total,total:a.total})}return i.map(e=>(e.valor/=e.total,delete e.total,e)).filter(e=>e.x)}}function tf(e,t,i){return async(a,n)=>{let o;return await i.fetchPIG(e.includes(a)?Math.floor(t.find(e=>e.sigla==a).codigo_sdv/1e4):t.find(e=>e.municipio==a).codigo_sdv,n)}}function tv(e,t){return i=>{let a=e(i[1]);(i=i[0]).forEach(e=>{let i=e;for(let a of(i.data=new Date(i.data),t))if(i.data>=new Date(a.inicio)&&i.data<=new Date(a.termino)){i.x=a.inicio;break}});let n=i,o=[];for(let l of n){let r=o.find(e=>e.x.getTime()==l.x.getTime());r?(r.absoluto[l.ig]+=l.total,r.total+=l.total):o.push({x:l.x,absoluto:{PEQUENO:"PEQUENO"==l.ig?l.total:0,ADEQUADO:"ADEQUADO"==l.ig?l.total:0,GRANDE:"GRANDE"==l.ig?l.total:0},total:l.total})}return t.filter(e=>!o.map(e=>e.x.getTime()).includes(e.inicio.getTime())).forEach(e=>{o.push({x:e.inicio,absoluto:{PEQUENO:0,ADEQUADO:0,GRANDE:0},total:0})}),(o=o.map(e=>{e.percentual={},e.total?(e.percentual.PEQUENO=100*e.absoluto.PEQUENO/e.total,e.percentual.ADEQUADO=100*e.absoluto.ADEQUADO/e.total,e.percentual.GRANDE=100*e.absoluto.GRANDE/e.total):(e.percentual.PEQUENO=0,e.percentual.ADEQUADO=0,e.percentual.GRANDE=0),e.taxa={};let t=a.find(t=>t.x.getTime()==e.x.getTime());return t?(e.taxa.PEQUENO=1e3*e.absoluto.PEQUENO/t.valor,e.taxa.ADEQUADO=1e3*e.absoluto.ADEQUADO/t.valor,e.taxa.GRANDE=1e3*e.absoluto.GRANDE/t.valor):(e.taxa.PEQUENO=0,e.taxa.ADEQUADO=0,e.taxa.GRANDE=0),e})).sort((e,t)=>e.x.getTime()-t.x.getTime())}}function th(e){return t=>{let i=[];t.forEach(t=>{let a=t;if(a.data=new Date(a.data),!(2011>a.data.getFullYear())){for(let n of e)if(a.data>=new Date(n.inicio)&&a.data<=new Date(n.termino)){a.x=n.inicio;break}i.push(a)}});let a=[];for(let n of i){let o=a.find(e=>e.x.getTime()==n.x.getTime());o?o.valor+=n.valor:a.push({x:n.x,valor:n.valor})}return a.filter(e=>e.x)}}function tx(e,t,i){return async(a,n)=>{let o;return await i.fetchTotal(e.includes(a)?Math.floor(t.find(e=>e.sigla==a).codigo_sdv/1e4):t.find(e=>e.municipio==a).codigo_sdv,n)}}function tb(e,t){return i=>{let a=e(i[1]);i=i[0];let n=[];i.forEach(e=>{let i=e;if(i.data=new Date(i.data),!(2011>i.data.getFullYear())){for(let a of t)if(i.data>=new Date(a.inicio)&&i.data<=new Date(a.termino)){i.x=a.inicio;break}n.push(i)}});let o=[];for(let l of n){let r=o.find(e=>e.x.getTime()==l.x.getTime());r?r.absoluto+=l.valor:o.push({x:l.x,absoluto:l.valor})}return(o=o.filter(e=>e.x)).map(e=>{e.percentual={};let t=a.find(t=>t.x.getTime()==e.x.getTime());return t?e.percentual=100*e.absoluto/t.valor:e.percentual=0,e})}}function tg(e){return e`## Imports`}function ty(e){return e("sortablejs/Sortable.js")}function tA(e){return e("d3@5")}function tE(e,t,i,a,n,o,l){return function(r,s,d=r,c=s,u=e.width,p=60){var m=[r,s+1],f=e.height,v=e.margin,h=u-p-v.right,x=f-v.top-v.bottom,b=t.scaleLinear().domain(m).range([0,h]),g=t.select(i.svg(u,f));let y=g.append("g").attr("transform",`translate(${p}, ${v.top})`);var A=y.append("text").attr("id","labelleft").attr("x",0).attr("y",x+5).style("display",60==p?"inline":"none").text(a[n[m[0]].inicio.getMonth()]+" "+n[m[0]].inicio.getFullYear()),E=y.append("text").attr("id","labelright").attr("x",0).attr("y",x+5).style("display",60==p?"inline":"none").text(a[n[m[1]].termino.getMonth()]+" "+n[m[1]].termino.getFullYear());y.append("text").attr("id","labelleft2").attr("x",-8).attr("y",x-x/2+1).style("alignment-baseline","middle").text(2012),y.append("text").attr("id","labelright2").attr("x",h+8).attr("y",x-x/2+1).style("alignment-baseline","middle").text(2019);var C=t.brushX().extent([[0,0],[h,x]]).on("brush",function(){var e=t.event.selection;A.attr("x",e[0]).text(a[n[Math.round(b.invert(e[0]))].inicio.getMonth()]+" "+n[Math.round(b.invert(e[0]))].inicio.getFullYear()),E.attr("x",e[1]).text(a[n[Math.round(b.invert(e[1]))].termino.getMonth()]+" "+n[Math.round(b.invert(e[1]))].termino.getFullYear()),O.attr("display",null).attr("transform",function(t,i){return"translate("+[e[i],-x/4]+")"}),g.node().value=e.map(e=>Math.round(b.invert(e))),g.node().dispatchEvent(new CustomEvent("input"))}).on("end",function(){if(t.event.sourceEvent){var e=t.event.selection.map(b.invert).map(Math.round);t.select(this).transition().call(t.event.target.move,e.map(b)),o.value=Math.max(Math.min(new Date(o.value),n[g.node().value[1]-2].termino),n[g.node().value[0]].inicio)}}),w=y.append("g").attr("class","brush").call(C),_=function(e){return"M -3 12 A 3 3 0 0 1 3 12 V 18 A 3 3 0 0 1 -3 18 Z"},O=w.selectAll(".handle--custom").data([{type:"w"},{type:"e"}]).enter().append("path").attr("class","handle--custom").attr("stroke","#000").attr("fill","#151472").attr("cursor","ew-resize").attr("y",x/2).attr("d",_);return w.selectAll(".overlay").attr("fill","#E5E5E5").each(function(e){e.type="selection"}).on("mousedown touchstart",function(){var e=b(1)-b(0),t=l.mouse(this)[0],i=t-e/2,a=t+e/2;l.select(this.parentNode).call(C.move,a>h?[h-e,h]:i<0?[0,e]:[i,a])}),w.call(C.move,[d,c+1].map(b)),y.append("g").selectAll("line").data(n.filter(e=>1==e.semana).map(e=>n.findIndex(t=>t==e))).enter().append("line").attr("x1",e=>b(e)).attr("x2",e=>b(e)).attr("y1",0).attr("y2",x).style("stroke","#ccc"),g.node()}}function tC(){return{width:600,height:60,margin:{top:20,bottom:20,left:60,right:60}}}function tw(e){return e`
<style>
@import url('https://fonts.googleapis.com/css2?family=Roboto+Condensed:wght@400;700&display=swap');
svg {
	font-family: "Roboto Condensed";
...
`}function t_(e){return e("https://bundle.run/lz-string@1.4.4")}function tO(e){return e`<style>
  @import url(https://fonts.googleapis.com/css2?family=Roboto+Condensed:wght@300;400;700&display=swap);
  @import url(https://fonts.googleapis.com/icon?family=Material+Icons);    
</style>
